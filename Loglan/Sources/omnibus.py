...
L("AlienText <- ((Comma0 [\"] (![\"] .)+ [\"])/(Comma0 (!Comma0 !Terminal .)+ (Comma0 [Yy] Comma0 (!Comma0 !Terminal .)+)*))")
...
L("AlienWord <- (&caprule ((HOIalien Juncture? &(Comma0 [\"]))/(HUEalien Juncture? &(Comma0 [\"]))/(LIEalien Juncture?)/(LAOalien Juncture?)/(LIOalien Juncture?)/(SAOalien Juncture?)/(SUEalien Juncture?)) AlienText)")

L("Alienmarker <- ((([Hh] [Oo] [Ii] Juncture? &[\"])/([Hh] [Uu] Juncture? [Ee] Juncture? &(Comma0 [\"]))/([Ll] [Ii] Juncture? [Ee] Juncture?)/([Ll] [Aa] [Oo] Juncture?)/([Ll] [Ii] Juncture? [Oo] Juncture?)/([Ss] [Aa] [Oo] Juncture?)/([Ss] [Uu] Juncture? [Ee] Juncture?)) !Vo1)")
...
L("CcvCvStressed <- (Initial Vo2 Stress2 Co1 Vo2 Dash? !Vo2)")
...
L("PhoneticUtterance <- (PhoneticUtterance1/Comma1/Terminal)+")
...
L("OptPause <- (Comma1 !(Vo1/Connective) &caprule)")
