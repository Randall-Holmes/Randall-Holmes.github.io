...
\date{8/24/2024, 11 am Boise time}
...
\item[11/29/2024:]  The use of {\bf gio} is now optional.  {\bf hue} followed by an argument followed by a subject initial statement will now be parsed as an inverse vocative of the argument, followed by the subject-initial statement.  This appears to be a good solution to the problem which caused {\bf gio} to be introduced in the first place, and allows the quite valid objections to mandatory {\bf gio} by poets to be taken into account.
