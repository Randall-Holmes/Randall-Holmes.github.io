...
L("LANAME <- (([ ])* LA0 (CANCELPAUSE / (([ ])* &(C1))) name)")

L("LANAME2 <- (([ ])* LA0 ((',' ([ ])+) / (([ ])* &(V1))) name)")

L("HOI0 <- ((([Hh] OI) / ([Ll] OI) / ([Ll] OA) / ([Ss] IA) / ([Ss] IE) / ([Ss] IU)) !(badspaces))")

L("voc <- ((([ ])* HOI0 (CANCELPAUSE / (([ ])* &(C1))) name) / (HOI !(badspaces) (freemod)? descpred (guea)? (((((comma)? CI (comma)?) / (comma &(nonamemarkers) !(AcronymicName))) name))?) / (HOI !(badspaces) (freemod)? argument1 (guua)?) / (([ ])* HOI0 ((',' ([ ])+) / (([ ])* &(V1))) name) / (H OI stringnospacesclosedblock))")
...
L("arg1 <- (abstractn / (LIO (freemod)? descpred (guea)?) / (LIO (freemod)? argument1 (guua)?) / (LIO (freemod)? mex (gap)?) / (LIO stringnospaces) / LAO / LANAME / (descriptn (guua)? (((((comma)? CI (comma)?) / (comma &(nonamemarkers) !(AcronymicName))) name))?) / LANAME2 / LIU1 / LIE / LI)")

L("arg1a <- ((DA / TAI / arg1 / (GE (freemod)? arg1a)) (freemod)?)")

L("argmod1 <- (((__LWinit (N o) ([ ])*))? ((JI (freemod)? predicate) / (JIO (freemod)? sentence) / (JIO (freemod)? uttAx) / (JI (freemod)? modifier) / (JI (freemod)? argument1)))")
...
L("argument1 <- (((arg8 (freemod)? AGE (freemod)? argument) / arg8) ((GUU (freemod)? argmod))*)")
...
L("statement <- (gasent / (subject (freemod)? ((GIO (freemod)? terms))? predicate))")
...
L("sen1 <- (((neghead (freemod)?))* ( statement / predicate / keksent))")
...
L("invvoc <- ((([ ])* HUE0 (CANCELPAUSE / (([ ])* &(C1))) name) / (HUE !(badspaces) (freemod)? descpred (guea)? (((((comma)? CI (comma)?) / (comma &(nonamemarkers) !(AcronymicName))) name))?) / (HUE !(badspaces) (freemod)? statement (giuo)?) / (HUE !(badspaces) (freemod)? argument1 (guu)?) / (([ ])* HUE0 ((',' ([ ])+) / (([ ])* &(V1))) name) / (HUE stringnospacesclosedblock))")

L("freemod <- ((NOUI / (SOI (freemod)? descpred (guea)?) / DIE / (NO1 DIE) / (KIE (comma)? utterance0 (comma)? KIU) / invvoc / voc / CANCELPAUSE / (comma !((&(nonamemarkers) Name))) / JO / UI1 / (([ ])* '...' ((([ ])* &(letter)))?) / (([ ])* '--' ((([ ])* &(letter)))?)) (freemod)?)")
