...
L("Mono <- ((([Aa] [o]) !([o])) / ((V2 [i]) !([i])) / ([Ii] V2) / ([Uu] V2))")

L("EMono <- ((([Aa] [o]) !([o])) / (([AEOaeo] [i]) !([i])))")
...
L("connective <- (ACI / AGE / A1 / ICI / ICA / IGE / I)")
...
L("SA <- (!(BadNIStress) ((S a) / (S i) / (S u)) (NOI)?)")
...
L("IE1 <- (__LWinit IE !(connective))")

L("NI2 <- ((((SA)? ((NI1)+ / RA1)) / SA) (NOI)? ((CA0 (((SA)? ((NI1)+ / RA1)) / SA) (NOI)?))*)")

L("NI <- (__LWinit (IE1)? NI2 ((&((M UE)) Acronym (comma / &(end) / &(period)) !((C u))))? ((C u))?)")

L("mex <- (__LWinit NI !(connective))")

L("CI <- (__LWinit (C i) !(connective))")
...
L("PA0 <- ((G IA) / (G UA) / (P AU) / (P IA) / (P UA) / (N IA) / (N UA) / (B IU) / (F EA) / (F IA) / (F UA) / (V IA) / (V II) / (V IU) / (C IU) / (C OI) / (D AU) / (D II) / (D UO) / (F OI) / (F UI) / (G AU) / (H EA) / (K AU) / (K II) / (K UI) / (L IA) / (L UI) / (M IA) / (M OU) / (N UI) / (P EU) / (R OI) / (R UI) / (S EA) / (S IO) / (T IE) / (V a) / (V i) / (V u) / (P a) / (N a) / (F a) / (V a) / (KOU !(KI)))")
...
L("LI <- ((__LWinit LI1 !(V2) (Quotemod)? ((([,])? ([ ])+))? utterance0 (', ')? __LWinit LU1 !(connective)) / (__LWinit LI1 !(V2) (Quotemod)? comma name (comma)? __LWinit LU1 !(connective)))")
...
L("LIE <- (([ ])* (LIE1 (Quotemod)? stringnospaces (([y] stringnospaces))*))")
...
L("GUI <- (__LWinit (G UI) !(connective))")
...
L("JI <- (__LWinit ((J IE) / (J AE) / (P e) / (J i) / (J a) / (N u J i)) !(connective))")

L("JIO <- (__LWinit ((J IO) / (J AO)) !(connective))")
...
L("HOI <- (__LWinit ((H OI) / (L OI) / (L OA) / (S IA) / (S IE) / (S IU)) !(connective))")
...
L("UI0 <- (!(Predicate) (UA / UE / UI / UO / UU / OA / OE / OI / OU / OO / IA / II / IO / IU / EA / EE / EI / EO / EU / AA / AE / AI / AO / AU / (B EA) / (B UO) / (C EA) / (C IA) / (C OA) / (D OU) / (F AE) / (F AO) / (F EU) / (G EA) / (K UO) / (K UU) / (R EA) / (N AO) / (N IE) / (P AE) / (P IU) / (S AA) / (S UI) / (T AA) / (T OE) / (V OI) / (Z OU) / (L OI) / (L OA) / (S IA) / (S II) / (T OE) / (S IU) / (C AO) / (C EU) / (S IE) / (S EU)))")

L("NOUI <- ((__LWinit N [o] ([ ])* UI0 !(connective)) / (__LWinit UI0 NOI !(connective)))")

L("UI1 <- (__LWinit (UI0 / (NI F i)) !(connective))")

L("HUE <- (__LWinit (H UE) !(connective))")

L("NO1 <- (__LWinit !(KOU1) !(NOUI) (N o) !((__LWinit KOU)) !((([ ])* (JIO / JI))) !(connective))")
...
L("mod1a <- (PA3 (freemod)? argument1 (gap)?)")

L("mod1 <- ((PA3 (freemod)? argument1 (gap)?) / (PA2 (freemod)? !(barepred) (gap)?))")
...
L("name <- (DJAN (((CI0 DJAN) / (CI !(badspaces) (comma)? predunit !((&(nonamemarkers) Name))) / (CI (comma)? DJAN) / (&(nonamemarkers) Name)))* (freemod)?)")
...
L("arg1 <- (abstractn / (LIO (freemod)? descpred (gap)?) / (LIO (freemod)? term (gap)?) / (LIO (freemod)? mex (gap)?) / (LIO stringnospaces) / LAO / LANAME / (descriptn (((((comma)? CI (comma)?) / (comma &(nonamemarkers) !(AcronymicName))) name))? (gap)?) / LANAME2 / LIU1 / LIE / LI)")
...
L("argument1 <- (((arg8 (freemod)? AGE (freemod)? argument) / arg8) ((GUU (freemod)? argmod (gap)?))*)")
...
L("invvoc <- ((([ ])* HUE0 (CANCELPAUSE / (([ ])* &(C1))) name (gap)?) / (HUE !(badspaces) (freemod)? descpred (((((comma)? CI (comma)?) / (comma &(nonamemarkers) !(AcronymicName))) name))? (gap)?) / (HUE !(badspaces) (freemod)? statement (gap)?) / (HUE !(badspaces) (freemod)? termset1) / (([ ])* HUE0 ((',' ([ ])+) / (([ ])* &(V1))) name (gap)?) / (HUE stringnospacesclosedblock))")

L("freemod <- ((NOUI / (SOI (freemod)? descpred (gap)?) / DIE / (NO1 DIE) / (KIE (comma)? utterance0 (comma)? KIU) / invvoc / voc / CANCELPAUSE / (comma !((&(nonamemarkers) Name))) / JO / UI1 / (([ ])* '...' ((([ ])* &(letter)))?) / (([ ])* '--' ((([ ])* &(letter)))?)) (freemod)?)")
