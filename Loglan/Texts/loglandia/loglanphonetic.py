...
L("alienmarker <- (([Hh] [Oo] [Ii] juncture? &([,]? [ ]+ [\"]))/([Hh] [Uu] juncture? [Ee] juncture? &([,]? [ ]+ [\"]))/([Ll] [Ii] juncture? [Ee] juncture?)/([Ll] [Aa] juncture? [Oo] juncture?)/([Ss] [Aa] juncture? [Oo] juncture?)/([Ss] [Uu] juncture? [Ee] juncture?))")
...
L("MarkedName <- (&caprule ((([Ll] !pause [Aa] juncture?)/([Hh] [Oo] !pause [Ii] juncture?)/([Hh] [Uu] juncture? !pause [Ee] juncture?)/([Cc] !pause [Ii] juncture?)/([Ll] [Ii] juncture? !pause [Uu] juncture?)/([Gg] [Aa] !pause [Oo] juncture?)) [ ]* &C1 &caprule PreName))")

L("FalseMarked <- (&PreName (!MarkedName character)* MarkedName)")

L("NameWord <- (((&caprule MarkedName)/([,] [ ]+ !FalseMarked &caprule PreName)/(&V1 !FalseMarked &caprule PreName)/(&caprule ((([Ll] [Aa] juncture?)/([Hh] [Oo] [Ii] juncture?)/([Cc] [Ii] juncture?)/([Ll] [Ii] [Uu] juncture?)) !V1 [,]? [ ]* &caprule PreName))) (([,]? [ ]+ !FalseMarked &caprule PreName)/([,]? [ ]+ &([Cc] [Ii]) NameWord))* &(([ ]* [Cc] [Ii] predunit)/(&(([,] [ ]+)/terminal/!.) .)/!.))")

L("namemarker <- ((([Ll] [Aa] juncture?)/([Hh] [Oo] [Ii] juncture?)/([Hh] [Uu] juncture? [Ee] juncture?)/([Cc] [Ii] juncture?)/([Ll] [Ii] juncture? [Uu] juncture?)/([Gg] [Aa] [Oo] juncture?)) !V1)")
...
L("Cmapua <- (&caprule !badnamemarker ((!predstart [Nn] [Oo] juncture? (VV/([Ii] [Yy])/([Uu] [Yy])) !([\'*] [ ]* predstart) juncture?)/((!predstart (VV/([Ii] [Yy])/([Uu] [Yy])) !([\'*] [ ]* predstart) juncture?)+/(((!predstart V1 !([\'*] [ ]* predstart) juncture?)/(!predstart CmapuaUnit)) (!namemarker !alienmarker !predstart CmapuaUnit)*))/(!predstart V2 !([\'*] [ ]* predstart) juncture?)) !V1 !([ ]* connective))")
...
L("LiQuote <- (&caprule [Ll] [Ii] juncture? comma2? [\"] phoneticutterance [\"] comma2? &caprule [Ll] [Uu] juncture? !([ ]* connective))")
...
L("TAI0 <- ((V1 juncture? M a)/(V1 juncture? F i)/(V1 juncture? Z i)/(!predstart C1 AI u?)/(!predstart C1 EI u?)/(!predstart C1 EO)/(Z [i] V1 !badstress juncture? !V1 (M a)?))")

L("NOI <- (N OI)")

L("A0 <- (&Cmapua (a/e/o/u/(H a)))")

L("A <- ([ ]* !predstart !TAI0 (N [u] &(u/(N [o])))? (N [o])? A0 NOI? !([ ]+ PANOPAUSES PAUSE) !(PANOPAUSES !PAUSE [ ,]) (PANOPAUSES ((F i)/&PAUSE))?)")

L("ANOFI <- ([ ]* (!predstart !TAI0 ((N [u]) &(u/(N [o])))? (N [o])? A0 NOI? PANOPAUSES?))")
