...
\item Thus the lemma to be proved is simplified:  it suffices to prove that the collection of orbits in $\tau_\gamma$ under substitutions whose actions fix a given $\gamma$-support is of cardinality $<\mu$.
