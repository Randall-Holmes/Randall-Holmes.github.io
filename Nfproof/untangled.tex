...
Let $\mu$ be a strong limit cardinal $>\kappa$ of cofinality at least $\kappa$.
...
$A_\gamma(\alpha,\beta,B)$ as $$(\alpha,\gamma,\{(\gamma,-1,N):N \in f_{\beta,\gamma}``B\}).$$ Notice that since the ranges of $f_{\beta,\gamma}$ and $f_{\beta,\delta}$ are disjoint if $\beta \neq \delta$, it follows that the ranges of
...
It is a useful observation that because $\mu$ has cofinality at least $\kappa$, there are no more than $\mu$ (and so exactly $\mu$) near-litters,
