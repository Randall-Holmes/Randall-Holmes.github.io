...
For $S$ a support, we define $S_a$ as the element $x$ of its domain such that the restriction of $S$ to $\{y:y <_S x\}$ is of order type $a$.  We define
$S_{<a}$ as $\{y:y <_S x\}$.
...
$S^*_a$ is $((\beta,-1,\chi_{x,\{y:y <_S S_a\}^\gamma},A)$:  the component replacing $N$ is the coding function with largest possible domain taken from $S$ which yields $x$.
...
then $S^*_a$ is $((\beta,-1,\chi_{x,\{y:y <_S S_a\}^\gamma},A)$ and $T^*_a$ is $((\beta,-1,\chi_{x,\{y:y <_T x\}^\gamma},A).$

If all earlier items in $S$ are mapped by a fixed allowable permutation $\pi_0$ to the corresponding items in $T$, then
$$\pi_0(x) = \pi_0(\chi_{x,\{y:y <_S S_a\}^\gamma}(\{y:y <_S S_a\}^\gamma) $$ $$ = \chi_{x,\{y:y <_S S_a\}^\gamma}(\pi_0[\{y:y <_S S_a\}^\gamma])$$ $$ = \chi_{x,\{y:y <_S S_a\}^\gamma}(\{y:y <_T S_a\}^\gamma) $$ $$= \chi_{x,\{y:y <_T S_a\}^\gamma}(\{y:y <_T S_a\}^\gamma)=y$$
