...
already by recursive hypothesis computed the values of $\pi_{A \setminus \{\beta\} \cup \{\gamma\}}$ at these litters, and we can simply supply those values for $\chi_{\{\gamma\}}$ as data in the calculation of $(\pi_{A \setminus \{\beta\} \cup \{\gamma\}}(y)$.
