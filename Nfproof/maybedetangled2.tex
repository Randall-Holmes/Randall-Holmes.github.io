...
\item  If $S_\epsilon$ is $(N,A)$ and $N$ is a near-litter, where $\beta={\tt min}(A)$, and either $|A|=1$ or $N^\circ$ is not in the range of any $f_{\gamma,\beta}$ for $\gamma<{\tt min}(A_1)$, then $S^*_\epsilon$ is $(1,\beta,\Sigma,A)$, where
$\Sigma$ is the set of all $(\delta_1,\delta_2)$ such that $\pi_2(S_{\delta_1}) = \pi_2(S_{\delta_2}) = A$ and $\pi_1(S_{\delta_1})\sim N$ and $\pi_1(S_{\delta_2}) \subseteq \pi_1(S_{\delta_1}) \Delta N$.
...
$S^*_\epsilon$ is $(2,\beta,\chi_{x,T},F,\Sigma,A)$, where $F$ is a function from the domain of $T$ into $\epsilon$
such that $S_{F(\delta)} = (T^{\uparrow A_1})_\delta$ for each $\delta$ in the domain of $T$ and $\Sigma$ is the set of all $(\delta_1,\delta_2)$ such that $\pi_2(S_{\delta_1}) = \pi_2(S_{\delta_2}) = A$ and $\pi_1(S_{\delta_1})\sim N$ and $\pi_1(S_{\delta_2}) \subseteq \pi_1(S_{\delta_1}) \Delta N$.

\item  If $S_\epsilon$ is $(N,A)$ and $N$ is a near-litter, where $\beta={\tt min}(A)$, and $N^\circ=f_{-1,\beta}(x,\emptyset)$  then $S^*_\epsilon$ is $(3,\beta,\Sigma_1,\Sigma_2,A)$, where  $\Sigma_1$ is the set of all $\delta$ such that $S_\delta$ is $(\{x\},A_1)$
and and $\Sigma_2$ is the set of all $(\delta_1,\delta_2)$ such that $\pi_2(S_{\delta_1}) = \pi_2(S_{\delta_2}) = A$ and $\pi_1(S_{\delta_1})\sim N$ and $\pi_1(S_{\delta_2}) \subseteq \pi_1(S_{\delta_1}) \Delta N$.
