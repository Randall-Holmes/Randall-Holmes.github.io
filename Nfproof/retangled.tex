...
A nonempty finite subset of $\lambda \cup \{-1\}$ may be termed an extended type index.  If $A$ is an extended type index with at least two elements, $A_1$ is defined as $A \setminus \{{\tt min}(A)\}$.
