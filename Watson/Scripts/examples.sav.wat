declareconstant "BUBBLED";
declareconstant "BUBBLE0D";
declareconstant "COPY2D";
declareconstant "PURGED";
declareconstant "CANCELTWIDDLE2D";
declareconstant "CANCELTWIDDLE1D";
declareconstant "IDEMTWIDDLED";
declareconstant "BUBBLEC";
declareconstant "BUBBLE0C";
declareconstant "COPY2C";
declareconstant "PURGEC";
declareconstant "CANCELTWIDDLE2C";
declareconstant "CANCELTWIDDLE1C";
declareconstant "IDEMTWIDDLEC";
declareconstant "TRUTHVALUES";
declareconstant "COMMZERD";
declareconstant "COMMZERC";
declareconstant "COMMIDD";
declareconstant "COMMIDC";
declareconstant "ALLASSOCSD";
declareconstant "ASSOCSD";
declareconstant "ALLASSOCSC";
declareconstant "ASSOCSC";
declareconstant "DNFPUSH2";
declareconstant "DNFPUSH1";
declareconstant "DNFPUSH";
declareconstant "NEGPUSH5";
declareconstant "NEGPUSH4";
declareconstant "NEGPUSH3";
declareconstant "NEGPUSH2";
declareconstant "NEGPUSH1";
declareconstant "NEGPUSH";
declareconstant "DEFPUSH";
declareconstant "SINGLE_ELIM_D";
declareconstant "IFF_DNF";
declareconstant "DISTC2";
declareconstant "BREFLEX";
declareconstant "TASSERT";
declareconstant "SHUNTING";
declareconstant "CONJ_IMP_1";
declareconstant "ABSORBD";
declareconstant "ALT_INTRO";
declareconstant "ALT_ELIM";
declareconstant "NOR";
...
forcetheorem "ABSORBD" "ABSORBD , ?y | ?x & ?y , |- ?y , ASSERTS , ASSOCD , CANCELD , COMMC , COMMD , DISTC , IDC , IDEMD , OR_TYPE , 0";
forcetheorem "CONJ_IMP_1" "CONJ_IMP_1 , ?p & ?q -> ?p , true , ASSOCD , CANCELD , COMMD , DEMC , IF_DEF , ZERD , 0";
forcetheorem "SHUNTING" "SHUNTING , (?p & ?q -> ?r <-> ?p -> ?q -> ?r) , true , ASSERTS , ASSOCD , CANCELD , COMMD , DEMC , IDC , IFF_DEF , IF_DEF , OR_TYPE , 0";
forcetheorem "DRULE1" "DRULE1 , ?x | ?y , |- (?x | ?y) , ASSERTS , OR_TYPE , 0";
forcetheorem "TASSERT" "TASSERT , |- true , true , ASSERTS , CANCELD , OR_TYPE , 0";
forcetheorem "BREFLEX" "BREFLEX , (?p <-> ?p) , true , ASSERTS , CANCELD , COMMD , IDC , IFF_DEF , IF_DEF , OR_TYPE , 0";
...
forcetheorem "IFF_DNF" "IFF_DNF , (?p <-> ?q) , (?p & ?q) | ~ ?p & ~ ?q , ASSERTS , CANCELC , COMMC , COMMD , DISTC , IDD , IFF_DEF , IF_DEF , OR_TYPE , 0";
forcetheorem "ALT_INTRO" "(ALT_INTRO @ ?y) , |- ?x , (?x & ?y) | ?x & ~ ?y , CANCELD , DISTC , IDC , 0";
...
forcetheorem "ALT_ELIM" "ALT_ELIM , (?x & ?y) | ?x & ~ ?y , |- ?x , CANCELD , DISTC , IDC , 0";
forcetheorem "CRULE1" "CRULE1 , ?x & ?y , |- (?x & ?y) , AND_TYPE , ASSERTS , 0";
forcetheorem "SINGLE_ELIM_D" "SINGLE_ELIM_D , (?p & ?q & ?r) | ?p & ~ ?q , (?p & ?r) | ?p & ~ ?q , AND_TYPE , ASSERTS , ASSOCC , ASSOCD , CANCELD , COMMC , DISTC , IDC , IDEMD , OR_TYPE , 0";
forcetheorem "DEFPUSH" "DEFPUSH , ?x , ((EVERYWHERE @ IF_DEF) => (EVERYWHERE @ IFF_DEF) => (EVERYWHERE @ XOR_DEF) => ?x) , 0";
forcetheorem "DNEG" "DNEG , ~ ~ ?x , |- ?x , DNEG , 0";
forcetheorem "NEGPUSH1" "NEGPUSH1 , ~ ~ ?x , ((NRULE1 <<= DRULE1 <<= CRULE1) <= |- (NEGPUSH => ?x)) , DNEG , 0";
forcetheorem "DEMC" "DEMC , ~ (?x & ?y) , ~ ?x | ~ ?y , DEMC , 0";
forcetheorem "NEGPUSH2" "NEGPUSH2 , ~ (?x & ?y) , (DRULE3 <= DRULE2 <= (NEGPUSH => ~ ?x) | (NEGPUSH => ~ ?y)) , DEMC , 0";
forcetheorem "DEMD" "DEMD , ~ (?x | ?y) , ~ ?x & ~ ?y , DEMD , 0";
forcetheorem "NEGPUSH3" "NEGPUSH3 , ~ (?x | ?y) , (CRULE3 <= CRULE2 <= (NEGPUSH => ~ ?x) & (NEGPUSH => ~ ?y)) , DEMD , 0";
forcetheorem "NEGPUSH4" "NEGPUSH4 , ?x & ?y , (CRULE3 <= CRULE2 <= (NEGPUSH => ?x) & (NEGPUSH => ?y)) , 0";
forcetheorem "NEGPUSH5" "NEGPUSH5 , ?x | ?y , (DRULE3 <= DRULE2 <= (NEGPUSH => ?x) | (NEGPUSH => ?y)) , 0";
forcetheorem "NEGPUSH" "NEGPUSH , ?x , ((NEGPUSH1 =>> NEGPUSH2 =>> NEGPUSH3 =>> NEGPUSH4 =>> NEGPUSH5) => ?x) , 0";
forcetheorem "DNFPUSH1" "DNFPUSH1 , ?x | ?y , (DNFPUSH => ?x) | (DNFPUSH => ?y) , 0";
forcetheorem "DNFPUSH2" "DNFPUSH2 , ?x & ?y , (DNFPUSH1 => DISTC2 => DISTC => (DNFPUSH => ?x) & (DNFPUSH => ?y)) , 0";
forcetheorem "DNFPUSH" "DNFPUSH , ?x , ((DNFPUSH1 =>> DNFPUSH2) => ?x) , 0";
forcetheorem "ASSOCSC" "ASSOCSC , (?x & ?y) & ?z , (ASSOCSC => ?x & ?y & ?z) , ASSOCC , 0";
forcetheorem "ALLASSOCSC" "ALLASSOCSC , ?x & ?y , ((RIGHT @ ALLASSOCSC) => ASSOCSC => ?x & ?y) , 0";
forcetheorem "ASSOCSD" "ASSOCSD , (?x | ?y) | ?z , (ASSOCSD => ?x | ?y | ?z) , ASSOCD , 0";
forcetheorem "ALLASSOCSD" "ALLASSOCSD , ?x | ?y , ((RIGHT @ ALLASSOCSD) => ASSOCSD => ?x | ?y) , 0";
forcetheorem "COMMIDC" "COMMIDC , true & ?x , |- ?x , COMMC , IDC , 0";
forcetheorem "COMMIDD" "COMMIDD , false | ?x , |- ?x , COMMD , IDD , 0";
forcetheorem "COMMZERC" "COMMZERC , false & ?x , false , COMMC , ZERC , 0";
forcetheorem "COMMZERD" "COMMZERD , true | ?x , true , COMMD , ZERD , 0";
forcetheorem "TRUTHVALUES" "TRUTHVALUES , ?x , (CLEANUP => (EVERYWHERE @ ZERD ** COMMZERD ** ASSERT_TRUE) => (EVERYWHERE @ IDD ** COMMIDD) => CLEANUP => (EVERYWHERE @ ZERC ** COMMZERC ** ASSERT_FALSE) => (EVERYWHERE @ IDC ** COMMIDC) => ?x) , 0";
forcetheorem "IDC" "IDC , ?x & true , |- ?x , IDC , 0";
forcetheorem "IDEMTWIDDLEC" "IDEMTWIDDLEC , ?p & ?p , ?p & true , IDC , IDEMC , 0";
forcetheorem "CANCELTWIDDLE1C" "CANCELTWIDDLE1C , ?p & ~ ?p , ?p & false , CANCELC , ZERC , 0";
forcetheorem "CANCELC" "CANCELC , ?x & ~ ?x , false , CANCELC , 0";
forcetheorem "ZERC" "ZERC , ?x & false , false , ZERC , 0";
forcetheorem "CANCELTWIDDLE2C" "CANCELTWIDDLE2C , ~ ?p & ?p , ~ ?p & false , CANCELC , COMMC , ZERC , 0";
...
forcetheorem "COPY2C" "COPY2C , ?p & ?q & ?r , ?p & (?p & ?q) & ?p & ?r , AND_TYPE , ASSERTS , ASSOCC , COMMC , IDEMC , 0";
forcetheorem "PURGEC" "PURGEC , ?p & ?q , ((RIGHT @ PURGEC) => (IDEMTWIDDLEC =>> CANCELTWIDDLE1C =>> CANCELTWIDDLE2C =>> COPY2C ** (RIGHT @ RL @ PURGEC) ** $ COPY2C) => ?p & ?q) , 0";
forcetheorem "BUBBLE0C" "BUBBLE0C , ?p & ?q & ?r , (ASSOCC => (LEFT @ FLIP @ COMMC) => ASSOCC <= ?p & ((BUBBLE0C =>> FLIP @ COMMC) => ?q & ?r)) , 0";
forcetheorem "BUBBLEC" "BUBBLEC , ?p & ?q , ((RIGHT @ BUBBLEC) => BUBBLE0C => ?p & ?q) , 0";
forcetheorem "IDD" "IDD , ?x | false , |- ?x , IDD , 0";
forcetheorem "IDEMTWIDDLED" "IDEMTWIDDLED , ?p | ?p , ?p | false , IDD , IDEMD , 0";
forcetheorem "CANCELTWIDDLE1D" "CANCELTWIDDLE1D , ?p | ~ ?p , ?p | true , CANCELD , ZERD , 0";
forcetheorem "CANCELD" "CANCELD , ?x | ~ ?x , true , CANCELD , 0";
forcetheorem "ZERD" "ZERD , ?x | true , true , ZERD , 0";
forcetheorem "CANCELTWIDDLE2D" "CANCELTWIDDLE2D , ~ ?p | ?p , ~ ?p | true , CANCELD , COMMD , ZERD , 0";
...
forcetheorem "COPY2D" "COPY2D , ?p | ?q | ?r , ?p | (?p | ?q) | ?p | ?r , ASSERTS , ASSOCD , COMMD , IDEMD , OR_TYPE , 0";
forcetheorem "PURGED" "PURGED , ?p | ?q , ((RIGHT @ PURGED) => (IDEMTWIDDLED =>> CANCELTWIDDLE1D =>> CANCELTWIDDLE2D =>> COPY2D ** (RIGHT @ RL @ PURGED) ** $ COPY2D) => ?p | ?q) , 0";
forcetheorem "BUBBLE0D" "BUBBLE0D , ?p | ?q | ?r , (ASSOCD => (LEFT @ FLIP @ COMMD) => ASSOCD <= ?p | ((BUBBLE0D =>> FLIP @ COMMD) => ?q | ?r)) , 0";
forcetheorem "BUBBLED" "BUBBLED , ?p | ?q , ((RIGHT @ BUBBLED) => BUBBLE0D => ?p | ?q) , 0";
forcetheorem "}backup" "backup , ?p | ?q , ((RIGHT @ BUBBLED) => BUBBLE0D => ?p | ?q) , 0";
adddef "NOR" "~|";
adddef "NAND" "~&";
...
setprogram "p2" "p2";
setprogram "p1" "p1";
adddefdep2 "BUBBLED" "OR , 0";
adddefdep2 "BUBBLE0D" "OR , 0";
adddefdep2 "PURGED" "OR , 0";
adddefdep2 "COPY2D" "OR , 0";
adddefdep2 "CANCELTWIDDLE2D" "OR , NOT , 0";
adddefdep2 "CANCELTWIDDLE1D" "OR , NOT , 0";
adddefdep2 "IDEMTWIDDLED" "OR , 0";
adddefdep2 "BUBBLEC" "AND , 0";
adddefdep2 "BUBBLE0C" "AND , 0";
adddefdep2 "PURGEC" "AND , 0";
adddefdep2 "COPY2C" "AND , 0";
adddefdep2 "CANCELTWIDDLE2C" "AND , NOT , 0";
adddefdep2 "CANCELTWIDDLE1C" "AND , NOT , 0";
adddefdep2 "IDEMTWIDDLEC" "AND , 0";
adddefdep2 "TRUTHVALUES" "0";
adddefdep2 "COMMZERD" "OR , 0";
adddefdep2 "COMMZERC" "AND , 0";
adddefdep2 "COMMIDD" "ASSERT , OR , 0";
adddefdep2 "COMMIDC" "ASSERT , AND , 0";
adddefdep2 "ALLASSOCSD" "OR , 0";
adddefdep2 "ASSOCSD" "OR , 0";
adddefdep2 "ALLASSOCSC" "AND , 0";
adddefdep2 "ASSOCSC" "AND , 0";
adddefdep2 "DNFPUSH" "0";
adddefdep2 "DNFPUSH2" "AND , 0";
adddefdep2 "DNFPUSH1" "OR , 0";
adddefdep2 "NEGPUSH" "0";
adddefdep2 "NEGPUSH5" "OR , 0";
adddefdep2 "NEGPUSH4" "AND , 0";
adddefdep2 "NEGPUSH3" "AND , NOT , OR , 0";
adddefdep2 "NEGPUSH2" "OR , NOT , AND , 0";
adddefdep2 "NEGPUSH1" "ASSERT , NOT , 0";
adddefdep2 "DEFPUSH" "0";
adddefdep2 "SINGLE_ELIM_D" "OR , AND , NOT , 0";
adddefdep2 "IFF_DNF" "OR , AND , NOT , IFF , 0";
adddefdep2 "DISTC2" "OR , AND , 0";
adddefdep2 "BREFLEX" "IFF , 0";
adddefdep2 "TASSERT" "ASSERT , 0";
adddefdep2 "SHUNTING" "IFF , IF , AND , 0";
adddefdep2 "CONJ_IMP_1" "IF , AND , 0";
adddefdep2 "ABSORBD" "ASSERT , OR , AND , 0";
adddefdep2 "ALT_INTRO" "OR , AND , NOT , ASSERT , 0";
adddefdep2 "ALT_ELIM" "ASSERT , OR , AND , NOT , 0";
...
adddefdep2 "TYPES" "0";
addthmtextdep2 "BUBBLED" "OR , RIGHT , RIGHT1 , RIGHT2 , BUBBLED , ASSOCD , LEFT , LEFT1 , LEFT2 , COMMD , BUBBLE0D , 0";
addthmtextdep2 "BUBBLE0D" "OR , ASSOCD , LEFT , LEFT1 , LEFT2 , COMMD , BUBBLE0D , 0";
...
addthmtextdep2 "PURGED" "OR , RIGHT , RIGHT1 , RIGHT2 , PURGED , IDEMTWIDDLED , CANCELTWIDDLE1D , NOT , CANCELTWIDDLE2D , COPY2D , RL , (?x $ ?y) , (?x ** ?y) , 0";
addthmtextdep2 "**" "(?x ** ?y) , 0";
addthmtextdep2 "$" "(?x $ ?y) , 0";
addthmtextdep2 "RL" "RL , 0";
addthmtextdep2 "COPY2D" "COPY2D , OR , 0";
addthmtextdep2 "CANCELTWIDDLE2D" "CANCELTWIDDLE2D , NOT , OR , 0";
addthmtextdep2 "CANCELTWIDDLE1D" "CANCELTWIDDLE1D , NOT , OR , 0";
addthmtextdep2 "NOT" "NOT , 0";
addthmtextdep2 "IDEMTWIDDLED" "IDEMTWIDDLED , OR , 0";
addthmtextdep2 "BUBBLEC" "AND , RIGHT , RIGHT1 , RIGHT2 , BUBBLEC , ASSOCC , LEFT , LEFT1 , LEFT2 , COMMC , BUBBLE0C , 0";
addthmtextdep2 "BUBBLE0C" "AND , ASSOCC , LEFT , LEFT1 , LEFT2 , COMMC , BUBBLE0C , 0";
addthmtextdep2 "COMMC" "COMMC , AND , 0";
addthmtextdep2 "ASSOCC" "ASSOCC , AND , 0";
addthmtextdep2 "AND" "AND , 0";
addthmtextdep2 "PURGEC" "AND , RIGHT , RIGHT1 , RIGHT2 , PURGEC , IDEMTWIDDLEC , CANCELTWIDDLE1C , NOT , CANCELTWIDDLE2C , COPY2C , RL , (?x $ ?y) , (?x ** ?y) , 0";
addthmtextdep2 "COPY2C" "COPY2C , AND , 0";
addthmtextdep2 "CANCELTWIDDLE2C" "CANCELTWIDDLE2C , NOT , AND , 0";
addthmtextdep2 "CANCELTWIDDLE1C" "CANCELTWIDDLE1C , NOT , AND , 0";
addthmtextdep2 "IDEMTWIDDLEC" "IDEMTWIDDLEC , AND , 0";
addthmtextdep2 "TRUTHVALUES" "TRUTHVALUES , CLEANUP , ASSERT_FALSE , ASSERT , ASSERT_TRUE , CRULE1 , AND , DRULE1 , OR , NRULE1 , NOT , EVERYWHERE_INFIX , EVERYWHERE , EVERYWHERE_PREFIX , EVERYWHERE_ABSTRACT , EVERYWHERE_CASES , NRULE2 , (?x $ ?y) , DRULE4 , CRULE4 , (?x ** ?y) , ASSERTS , ZERD , COMMZERD , IDD , COMMIDD , ZERC , COMMZERC , IDC , COMMIDC , 0";
addthmtextdep2 "COMMIDC" "COMMIDC , AND , ASSERT , 0";
addthmtextdep2 "IDC" "IDC , AND , ASSERT , 0";
addthmtextdep2 "COMMZERC" "COMMZERC , AND , 0";
addthmtextdep2 "ZERC" "ZERC , AND , 0";
addthmtextdep2 "COMMIDD" "COMMIDD , OR , ASSERT , 0";
addthmtextdep2 "IDD" "IDD , OR , ASSERT , 0";
addthmtextdep2 "COMMZERD" "COMMZERD , OR , 0";
...
addthmtextdep2 "ALLASSOCSD" "OR , RIGHT , RIGHT1 , RIGHT2 , ALLASSOCSD , ASSOCSD , 0";
addthmtextdep2 "ASSOCSD" "OR , ASSOCSD , 0";
addthmtextdep2 "ALLASSOCSC" "AND , RIGHT , RIGHT1 , RIGHT2 , ALLASSOCSC , ASSOCSC , 0";
addthmtextdep2 "ASSOCSC" "AND , ASSOCSC , 0";
addthmtextdep2 "DNFPUSH1" "DNFPUSH1 , OR , DNFPUSH , DNFPUSH2 , AND , DISTC2 , DISTC , 0";
addthmtextdep2 "DNFPUSH2" "DNFPUSH1 , OR , DNFPUSH , DNFPUSH2 , AND , DISTC2 , DISTC , 0";
addthmtextdep2 "DNFPUSH" "DNFPUSH1 , OR , DNFPUSH , DNFPUSH2 , AND , DISTC2 , DISTC , 0";
addthmtextdep2 "DISTC" "DISTC , OR , AND , 0";
addthmtextdep2 "DISTC2" "DISTC2 , OR , AND , 0";
addthmtextdep2 "NEGPUSH1" "NEGPUSH1 , NOT , NRULE1 , ASSERT , DRULE1 , OR , CRULE1 , AND , NEGPUSH , NEGPUSH2 , DRULE3 , DRULE2 , NEGPUSH3 , CRULE3 , CRULE2 , NEGPUSH4 , NEGPUSH5 , 0";
addthmtextdep2 "NEGPUSH2" "NEGPUSH1 , NOT , NRULE1 , ASSERT , DRULE1 , OR , CRULE1 , AND , NEGPUSH , NEGPUSH2 , DRULE3 , DRULE2 , NEGPUSH3 , CRULE3 , CRULE2 , NEGPUSH4 , NEGPUSH5 , 0";
addthmtextdep2 "NEGPUSH3" "NEGPUSH1 , NOT , NRULE1 , ASSERT , DRULE1 , OR , CRULE1 , AND , NEGPUSH , NEGPUSH2 , DRULE3 , DRULE2 , NEGPUSH3 , CRULE3 , CRULE2 , NEGPUSH4 , NEGPUSH5 , 0";
addthmtextdep2 "NEGPUSH4" "NEGPUSH1 , NOT , NRULE1 , ASSERT , DRULE1 , OR , CRULE1 , AND , NEGPUSH , NEGPUSH2 , DRULE3 , DRULE2 , NEGPUSH3 , CRULE3 , CRULE2 , NEGPUSH4 , NEGPUSH5 , 0";
addthmtextdep2 "NEGPUSH5" "NEGPUSH1 , NOT , NRULE1 , ASSERT , DRULE1 , OR , CRULE1 , AND , NEGPUSH , NEGPUSH2 , DRULE3 , DRULE2 , NEGPUSH3 , CRULE3 , CRULE2 , NEGPUSH4 , NEGPUSH5 , 0";
addthmtextdep2 "NEGPUSH" "NEGPUSH1 , NOT , NRULE1 , ASSERT , DRULE1 , OR , CRULE1 , AND , NEGPUSH , NEGPUSH2 , DRULE3 , DRULE2 , NEGPUSH3 , CRULE3 , CRULE2 , NEGPUSH4 , NEGPUSH5 , 0";
...
addthmtextdep2 "DEFPUSH" "DEFPUSH , EVERYWHERE_INFIX , EVERYWHERE , EVERYWHERE_PREFIX , EVERYWHERE_ABSTRACT , EVERYWHERE_CASES , IF_DEF , IF , NOT , OR , IFF_DEF , IFF , AND , XOR_DEF , XOR , 0";
...
addthmtextdep2 "SINGLE_ELIM_D" "SINGLE_ELIM_D , AND , NOT , OR , 0";
addthmtextdep2 "IFF_DNF" "IFF_DNF , IFF , AND , NOT , OR , 0";
addthmtextdep2 "BREFLEX" "BREFLEX , IFF , 0";
addthmtextdep2 "TASSERT" "TASSERT , ASSERT , 0";
addthmtextdep2 "SHUNTING" "SHUNTING , AND , IF , IFF , 0";
addthmtextdep2 "CONJ_IMP_1" "CONJ_IMP_1 , AND , IF , 0";
addthmtextdep2 "ABSORBD" "ABSORBD , AND , OR , ASSERT , 0";
addthmtextdep2 "ALT_INTRO" "ALT_INTRO , ASSERT , AND , NOT , OR , 0";
addthmtextdep2 "ALT_ELIM" "ALT_ELIM , AND , NOT , OR , ASSERT , 0";
