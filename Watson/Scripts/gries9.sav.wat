...
forcetheorem "}backup" "backup , ((?P @ ?x) -> ?Q) , ((LEFT @ ?thm) => ((forsome @ [?P @ ?1]) -> ?Q) || true , [(?P @ ?1) -> ?Q] @ ?x) , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , IF , NONTRIV , NOT1 , OR , REFLEX , AND , ODDCHOICE , TYPES , forall , forsome , 0";
