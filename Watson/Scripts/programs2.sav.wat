...
forcetheorem "REXPRETRACT" "REXPRETRACT , [((state : ?1) = [error]) || error , data : ?x @ state : ?1] , [((state : ?1) = [error]) || error , data : [((state : ?2) = [error]) || error , data : ?x @ state : ?2] @ state : ?1] , EQBOOL , TYPES , 0";
