...
forcetheorem "}backup" "backup , (forall @ [~ ?P @ Nat : ?1]) , (forall @ [(?P @ Nat : ?1) -> forsome @ [(?P @ Nat : ?2) & ?2 < ?1]]) , EQBOOL , FNDIST , LESS , MINUSTYPE , NONTRIV , NOT1 , REFLEX , TYPES , AND , BOOLDEF , CASEINTRO , EQUATION , forsome , IF , OR , ASSERT , ODDCHOICE , forall , HYP , INDUCTION , MINUSSUCC , MINUSZERO , ONENAT , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , SUCCNOTZERO , ZEROMINUS , ZERONAT , 0";
