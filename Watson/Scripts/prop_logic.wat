(* Parvin's logic file reworked Feb. 99 as a stand-alone theory
to support modal logic investigations *)
...
(* introduction of "prop" type of propositions -- not booleans *)

declareconstant "prop";
defineinfix "PROP" "|-?p" "prop:?p";
...
s "|- |- ?p";
ri "EVERYWHERE@PROP"; ex();
ri "TYPES";  rri "PROP"; ex();
p "TWOASSERTS";
