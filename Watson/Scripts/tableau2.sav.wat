...
forcetheorem "}backup" "backup , ((forall @ [forall @ [?P @ ?1 , ?2]]) == forall @ [forall @ [?P @ ?2 , ?1]]) , ((forall @ [forall @ [?P @ ?1 , ?2]]) || ((forall @ [forall @ [?P @ ?2 , ?1]]) || true , (forall @ [forall @ [?P @ ?2 , ?1]]) || true , (forall @ [?P @ ?1 , !!! [[~ [forall @ [?P @ ?5 , ?4]] @ ?3] @ ?2]]) || true , (?P @ (!!! [[~ [?P @ ?3 , !!! [[~ [forall @ [?P @ ?7 , ?6]] @ ?5] @ ?4]] @ ?2] @ ?1]) , !!! [[~ [forall @ [?P @ ?4 , ?3]] @ ?2] @ ?1]) || true , (forall @ [forall @ [?P @ ?1 , ?2]]) || ((forall @ [?P @ (*** [?P @ ?2 , *** [forall @ [?P @ ?4 , ?3]]]) , ?1]) || ((?P @ (*** [?P @ ?1 , *** [forall @ [?P @ ?3 , ?2]]]) , *** [forall @ [?P @ ?2 , ?1]]) || ((?P @ (*** [?P @ ?1 , *** [forall @ [?P @ ?3 , ?2]]]) , *** [forall @ [?P @ ?2 , ?1]]) || false , true) , true) , true) , true) , (forall @ [forall @ [?P @ ?2 , ?1]]) || ((forall @ [forall @ [?P @ ?1 , ?2]]) || true , (forall @ [?P @ (!!! [[~ [forall @ [?P @ ?4 , ?5]] @ ?3] @ ?2]) , ?1]) || true , (?P @ (!!! [[~ [forall @ [?P @ ?3 , ?4]] @ ?2] @ ?1]) , !!! [[~ [?P @ (!!! [[~ [forall @ [?P @ ?6 , ?7]] @ ?5] @ ?4]) , ?3] @ ?2] @ ?1]) || true , (forall @ [forall @ [?P @ ?2 , ?1]]) || ((forall @ [?P @ ?1 , *** [?P @ (*** [forall @ [?P @ ?3 , ?4]]) , ?2]]) || ((?P @ (*** [forall @ [?P @ ?1 , ?2]]) , *** [?P @ (*** [forall @ [?P @ ?2 , ?3]]) , ?1]) || ((?P @ (*** [forall @ [?P @ ?1 , ?2]]) , *** [?P @ (*** [forall @ [?P @ ?2 , ?3]]) , ?1]) || false , true) , true) , true) , true) , true) , EQBOOL , FNDIST , NONTRIV , NOT1 , REFLEX , forall , CASEINTRO , EQUATION , ODDCHOICE , BOOLDEF , CHOICE , forsome , IFF , 0";
