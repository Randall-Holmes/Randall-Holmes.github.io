...
forcetheorem "}backup" "backup , ((forall @ [forall @ [?P @ ?1 , ?2]]) == forall @ [forall @ [?P @ ?2 , ?1]]) , true , EQBOOL , forall , CASEINTRO , EQUATION , ODDCHOICE , BOOLDEF , CHOICE , COUNTER1 , FNDIST , NONTRIV , NOT1 , REFLEX , forsome , IFF , 0";
