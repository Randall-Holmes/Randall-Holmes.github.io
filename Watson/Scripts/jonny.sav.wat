declareconstant "ACK4";
declareconstant "ACK3";
declareconstant "ACK2";
declareconstant "ACK1";
declareconstant "SPLITCOMP";
declareconstant "UNTYPENUMERAL";
declareconstant "PLUSSPLIT";
declareconstant "PLUSSPLIT0";
declareconstant "DIVMOD";
declareconstant "EXP3s";
declareconstant "MAKESUCC";
declareconstant "MAKESUCC0";
declareconstant "TYPENUMERAL";
declareconstant "EXP3";
declareconstant "EXP2";
declareconstant "EXP1";
declareconstant "EXP0";
...
declareconstant "PLUSSUCC";
declareconstant "TIMESZERO";
declareconstant "TIMESSUCC";
declareconstant "ZEROMINUS";
declareconstant "PLUSMINUS";
declareconstant "MINUSZERO";
declareconstant "MINUSSUCC";
declareconstant "INDUCTION";
declareconstant "TYPEXPLUSLEFT";
declareconstant "TYPEXTIMESLEFT";
declareconstant "TYPEXMINUSLEFT";
declareconstant "TYPEXPLUSRIGHT";
declareconstant "TYPEXTIMESRIGHT";
declareconstant "TYPEXMINUSRIGHT";
declareconstant "INDSETUP";
declareconstant "IND_TAC";
declareconstant "SAMESUCC";
declareconstant "ZEROCOMM";
declareconstant "TIMESID";
declareconstant "ONECOMM";
declareconstant "ONEASSOC";
declareconstant "PLUSCOMM";
declareconstant "PLUSASSOC";
declareconstant "DIST";
declareconstant "COMMDIST";
declareconstant "COMMTIMESZERO";
declareconstant "COMMTIMESID";
declareconstant "TIMESCOMM";
declareconstant "TIMESASSOC";
declareconstant "PLUSMINUS2";
declareconstant "SELFMINUS";
declareconstant "NOT_EQ";
declareconstant "LESS";
declareconstant "LESSCOMP";
declareconstant "LESSTYPE";
declareconstant "LESSSCIN";
declareconstant "TYPEXLESSLEFT";
declareconstant "TYPEXLESSRIGHT";
declareconstant "TYPEX";
declareconstant "ZEROMINUS2";
declareconstant "ZEROMIN";
declareconstant "PLUSCANCEL";
declareconstant "LESSLEMMA1";
declareconstant "ZEROORSUCC";
declareconstant "MINUSPLUS1";
declareconstant "MINUSSUM";
declareconstant "LESS_THAN_ONE";
declareconstant "BOTHZERO";
declareconstant "SUB_SUCCS";
declareconstant "SUB_SUCC_LEMMA";
declareconstant "PRETRICHOTOMY";
declareconstant "ZERONOTONE";
declareconstant "MINUSDIFFS";
declareconstant "LESS_MONOTONE";
declareconstant "ZERO_LESS_SUCC";
declareconstant "LESS_SUCC";
declareconstant "TRICHOTOMY1";
declareconstant "NOT_LESS_THAN_SELF";
declareconstant "TRICHOTOMY2";
declareconstant "COMPLETE_INDUCTION";
declareconstant "CI_TAC";
declareconstant "NOT_IMP";
declareconstant "LNP";
declareconstant "LNP_TAC";
declareconstant "DESCENT";
declareconstant "WITNESSED";
addoperator "+++" "(0) , 0";
addoperator "*`2" "(0) , 0";
addoperator "|/" "(0) , 0";
addoperator "***" "(0) , 1";
...
forcetheorem "TIMESCOMP" "TIMESCOMP , (?x * ?y) , (?x *! ?y) , TIMESCOMP , 0";
forcetheorem "ONECOMM" "ONECOMM , (?x + 1) , (1 + ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "ONEASSOC" "ONEASSOC , ((?x + 1) + ?y) , (?x + ?y + 1) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "TIMESSUCC" "TIMESSUCC , (?x * ?y + 1) , ((?x * ?y) + ?x) , TIMESSUCC , 0";
forcetheorem "TIMESCOMM" "TIMESCOMM , (?x * ?y) , (?y * ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , ZERONAT , forall , 0";
forcetheorem "TIMESZERO" "TIMESZERO , (?x * 0) , 0 , TIMESZERO , 0";
forcetheorem "COMMTIMESZERO" "COMMTIMESZERO , (0 * ?x) , 0 , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , ZERONAT , forall , 0";
forcetheorem "COMMDIST" "COMMDIST , ((?y + ?z) * ?x) , ((?y * ?x) + ?z * ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , ZERONAT , forall , 0";
forcetheorem "COMMTIMESID" "COMMTIMESID , (1 * ?x) , (Nat : ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSTYPE , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , ZERONAT , forall , 0";
forcetheorem "TIMESASSOC" "TIMESASSOC , ((?x * ?y) * ?z) , (?x * ?y * ?z) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , ZERONAT , forall , 0";
forcetheorem "ZEROCOMM" "ZEROCOMM , (?x + 0) , (0 + ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "NOT_EQ" "NOT_EQ , (?x <> ?y) , (~ (Nat : ?x) = Nat : ?y) , NOT_EQ , 0";
forcetheorem "LESSCOMP" "LESSCOMP , (?x < ?y) , (?x <! ?y) , LESSCOMP , 0";
...
forcetheorem "LESSSCIN" "LESSSCIN , (?x < ?y) , ((Nat : ?x) < Nat : ?y) , EQBOOL , FNDIST , LESS , MINUSTYPE , NONTRIV , NOT1 , REFLEX , TYPES , 0";
forcetheorem "}TYPEX" "(TYPEX @ ?x) , ?y , ((TYPEXLESSRIGHT @ ?x) => (TYPEXLESSLEFT @ ?x) => (TYPEXMINUSRIGHT @ ?x) => (TYPEXTIMESRIGHT @ ?x) => (TYPEXPLUSRIGHT @ ?x) => (TYPEXMINUSLEFT @ ?x) => (TYPEXTIMESLEFT @ ?x) => (TYPEXPLUSLEFT @ ?x) => (VALUE @ [EVERYWHERE2 @ TYPEX @ ?x]) => (RL @ EVERYWHERE2 @ TYPEX @ ?x) => ?y) , 0";
forcetheorem "CIDEM" "CIDEM , (?p & ?p) , (|- ?p) , AND , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , ODDCHOICE , REFLEX , TYPES , 0";
forcetheorem "LESSLEMMA1" "LESSLEMMA1 , (?x < ?y) , (~ ((?y - ?x) + ?x) = Nat : ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , ZERONAT , forall , 0";
...
forcetheorem "ZEROORSUCC" "ZEROORSUCC , (forall @ [((Nat : ?1) = 0) | forsome @ [(Nat : ?1) = ?2 + 1]]) , true , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , REFLEX , TYPES , forall , forsome , 0";
forcetheorem "PLUSMINUS" "PLUSMINUS , ((?x + 1) - 1) , (Nat : ?x) , PLUSMINUS , 0";
forcetheorem "TAB_AND" "TAB_AND , (?p & ?q) , (?p || (?q || true , false) , false) , AND , EQUATION , ODDCHOICE , 0";
forcetheorem "NOT" "NOT , (~ ?y) , (?y || false , true) , NOT1 , 0";
forcetheorem "PLUSSUCC" "PLUSSUCC , (?x + ?y + 1) , ((?x + ?y) + 1) , PLUSSUCC , 0";
forcetheorem "CZER" "CZER , (?p & false) , false , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , ODDCHOICE , REFLEX , TYPES , 0";
forcetheorem "BOTHZERO" "BOTHZERO , ((?x + ?y) = 0) , (((Nat : ?x) = 0) & (Nat : ?y) = 0) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , forall , 0";
forcetheorem "SUB_SUCCS" "SUB_SUCCS , ((?x + 1) - ?y + 1) , (?x - ?y) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "SUB_SUCC_LEMMA" "SUB_SUCC_LEMMA , ((?x + 1) - ?y) , ((((?x + 1) - ?y) = 0) || ((?x + 1) - ?y) , (?x - ?y) + 1) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , forall , 0";
forcetheorem "ZEROMINUS" "ZEROMINUS , (0 - 1) , 0 , ZEROMINUS , 0";
forcetheorem "PLUSCANCEL" "PLUSCANCEL , ((?x + ?z) = ?y + ?z) , ((Nat : ?x) = Nat : ?y) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "PRETRICHOTOMY" "PRETRICHOTOMY , (|- (((?x + ?y - ?x) = Nat : ?y) & (?x - ?y) = 0) | ((?y + ?x - ?y) = Nat : ?x) & (?y - ?x) = 0) , true , AND , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , 0";
forcetheorem "MINUSSUM" "MINUSSUM , (?x - ?y + ?z) , ((?x - ?y) - ?z) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "SUCCNOTZERO" "SUCCNOTZERO , (0 = ?x + 1) , false , SUCCNOTZERO , 0";
...
forcetheorem "LESS_THAN_ONE" "LESS_THAN_ONE , (?x < 1) , ((Nat : ?x) = 0) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , 0";
forcetheorem "ASRTEQ" "ASRTEQ , (?e = ?f) , (|- ?e = ?f) , ASSERT , EQBOOL , 0";
forcetheorem "ZERO_LESS_SUCC" "ZERO_LESS_SUCC , (0 < ?x + 1) , true , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , LESS , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , 0";
...
forcetheorem "MINUSPLUS1" "MINUSPLUS1 , ((?x - 1) + 1) , (((Nat : ?x) = 0) || 1 , Nat : ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSTYPE , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , forall , 0";
forcetheorem "SAMESUCC" "SAMESUCC , ((?x + 1) = ?y + 1) , ((Nat : ?x) = Nat : ?y) , CASEINTRO , EQUATION , PLUSMINUS , PLUSTYPE , REFLEX , TYPES , 0";
...
forcetheorem "MINUSZERO" "MINUSZERO , (?x - 0) , (Nat : ?x) , MINUSZERO , 0";
forcetheorem "DXM" "DXM , (?p | ~ ?p) , true , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , NOT1 , ODDCHOICE , OR , REFLEX , 0";
forcetheorem "PLUSCOMM" "PLUSCOMM , (?x + ?y) , (?y + ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "PLUSMINUS2" "PLUSMINUS2 , ((?x + ?y) - ?y) , (Nat : ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "ONENAT" "ONENAT , 1 , (Nat : 1) , ONENAT , 0";
forcetheorem "EQSYMM" "EQSYMM , (?x = ?y) , (?y = ?x) , CASEINTRO , EQUATION , REFLEX , 0";
forcetheorem "ZERONOTONE" "ZERONOTONE , (0 = 1) , false , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , forall , 0";
...
forcetheorem "MINUSTYPE" "MINUSTYPE , (?x - ?y) , (Nat : (Nat : ?x) - Nat : ?y) , MINUSTYPE , 0";
forcetheorem "MINUSDIFFS" "MINUSDIFFS , ((?x + ?z) - ?y + ?z) , (?x - ?y) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "TRICHOTOMY1" "TRICHOTOMY1 , (((Nat : ?x) = Nat : ?y) | (?x < ?y) | ?y < ?x) , true , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , 0";
forcetheorem "NOT_LESS_THAN_SELF" "NOT_LESS_THAN_SELF , (?x < ?x) , false , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , ZERONAT , forall , 0";
...
forcetheorem "LESS_MONOTONE" "LESS_MONOTONE , ((?x + ?z) < ?y + ?z) , (?x < ?y) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
...
forcetheorem "LESS" "LESS , (?x < ?y) , (~ (?y - ?x) = 0) , LESS , 0";
forcetheorem "MINUSSUCC" "MINUSSUCC , (?x - ?y + 1) , ((?x - ?y) - 1) , MINUSSUCC , 0";
forcetheorem "SELFMINUS" "SELFMINUS , (?x - ?x) , 0 , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , ZERONAT , forall , 0";
forcetheorem "ZEROMINUS2" "ZEROMINUS2 , (0 - ?x) , 0 , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , ZEROMINUS , ZERONAT , forall , 0";
forcetheorem "FDEF" "FDEF , false , (~ true) , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , NOT1 , ODDCHOICE , REFLEX , 0";
forcetheorem "TRICHOTOMY2" "TRICHOTOMY2 , ((?x < ?y) -> ~ ?y < ?x) , true , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , 0";
...
forcetheorem "IND_TAC" "IND_TAC , (forall @ [?P @ ?1]) , ((EVERYWHERE2 @ EVAL) => INDUCTION => INDSETUP => forall @ [?P @ ?1]) , 0";
forcetheorem "INDUCTION" "INDUCTION , (forall @ [?P @ Nat : ?1]) , ((?P @ 0) & forall @ [(?P @ Nat : ?1) -> ?P @ ?1 + 1]) , INDUCTION , 0";
forcetheorem "ZEROMIN" "ZEROMIN , (?x < 0) , false , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , ZEROMINUS , ZERONAT , forall , 0";
...
forcetheorem "ZERONAT" "ZERONAT , 0 , (Nat : 0) , ZERONAT , 0";
forcetheorem "TAB_AND_2" "TAB_AND_2 , ((?p & ?q) || ?a , ?b) , (?p || (?q || ?a , ?b) , ?b) , AND , CASEINTRO , EQUATION , ODDCHOICE , 0";
forcetheorem "LESS_SUCC" "LESS_SUCC , (?x < ?y + 1) , (((Nat : ?x) = Nat : ?y) | ?x < ?y) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , 0";
...
forcetheorem "LESSTYPE" "LESSTYPE , (?x < ?y) , (bool : (Nat : ?x) < Nat : ?y) , EQBOOL , FNDIST , LESS , MINUSTYPE , NONTRIV , NOT1 , REFLEX , TYPES , 0";
...
forcetheorem "LNP" "LNP , (forsome @ [?P @ Nat : ?1]) , (forsome @ [(?P @ Nat : ?1) & forall @ [(?2 < ?1) -> ~ ?P @ Nat : ?2]]) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , forsome , 0";
forcetheorem "LNP_TAC" "LNP_TAC , (forsome @ [?P @ ?1]) , ((EVERYWHERE2 @ EVAL) => LNP => forsome @ [(BIND @ Nat : ?1) => ?P @ ?1]) , 0";
forcetheorem "CI_TAC" "CI_TAC , (forall @ [?P @ ?1]) , ((EVERYWHERE2 @ EVAL) => COMPLETE_INDUCTION => INDSETUP => forall @ [(BIND @ Nat : ?1) => ?P @ ?1]) , 0";
forcetheorem "INDSETUP" "INDSETUP , (forall @ [?P @ ?1]) , (forall @ [(BIND @ Nat : ?1) => (TYPEX @ ?1) => ?P @ ?1]) , 0";
forcetheorem "TYPEX" "(TYPEX @ ?x) , ?y , ((TYPEXLESSRIGHT @ ?x) => (TYPEXLESSLEFT @ ?x) => (TYPEXMINUSRIGHT @ ?x) => (TYPEXTIMESRIGHT @ ?x) => (TYPEXPLUSRIGHT @ ?x) => (TYPEXMINUSLEFT @ ?x) => (TYPEXTIMESLEFT @ ?x) => (TYPEXPLUSLEFT @ ?x) => (VALUE @ [EVERYWHERE2 @ TYPEX @ ?x]) => (RL @ EVERYWHERE2 @ TYPEX @ ?x) => ?y) , 0";
forcetheorem "VALUE" "(VALUE @ ?thm) , [?P @ ?1] , [(?thm @ ?1) => ?P @ ?1] , 0";
forcetheorem "TYPEXPLUSLEFT" "(TYPEXPLUSLEFT @ ?x) , (?x + ?y) , ((Nat : ?x) + ?y) , PLUSTYPE , TYPES , 0";
forcetheorem "TYPEXTIMESLEFT" "(TYPEXTIMESLEFT @ ?x) , (?x * ?y) , ((Nat : ?x) * ?y) , TIMESTYPE , TYPES , 0";
forcetheorem "TYPEXMINUSLEFT" "(TYPEXMINUSLEFT @ ?x) , (?x - ?y) , ((Nat : ?x) - ?y) , MINUSTYPE , TYPES , 0";
forcetheorem "TYPEXPLUSRIGHT" "(TYPEXPLUSRIGHT @ ?y) , (?x + ?y) , (?x + Nat : ?y) , PLUSTYPE , TYPES , 0";
forcetheorem "TYPEXTIMESRIGHT" "(TYPEXTIMESRIGHT @ ?y) , (?x * ?y) , (?x * Nat : ?y) , TIMESTYPE , TYPES , 0";
forcetheorem "TYPEXMINUSRIGHT" "(TYPEXMINUSRIGHT @ ?y) , (?x - ?y) , (?x - Nat : ?y) , MINUSTYPE , TYPES , 0";
forcetheorem "TYPEXLESSLEFT" "(TYPEXLESSLEFT @ ?x) , (?x < ?y) , ((Nat : ?x) < ?y) , EQBOOL , FNDIST , LESS , MINUSTYPE , NONTRIV , NOT1 , REFLEX , TYPES , 0";
forcetheorem "TYPEXLESSRIGHT" "(TYPEXLESSRIGHT @ ?y) , (?x < ?y) , (?x < Nat : ?y) , EQBOOL , FNDIST , LESS , MINUSTYPE , NONTRIV , NOT1 , REFLEX , TYPES , 0";
forcetheorem "COMPLETE_INDUCTION" "COMPLETE_INDUCTION , (forall @ [?P @ Nat : ?1]) , (forall @ [(forall @ [(?2 < ?1) -> ?P @ Nat : ?2]) -> ?P @ Nat : ?1]) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , 0";
...
forcetheorem "NOT_IMP" "NOT_IMP , (~ ?p -> ?q) , (?p & ~ ?q) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , IF , NONTRIV , NOT1 , ODDCHOICE , OR , REFLEX , TYPES , 0";
...
forcetheorem "DESCENT" "DESCENT , (forall @ [~ ?P @ Nat : ?1]) , (forall @ [(?P @ Nat : ?1) -> forsome @ [(?P @ Nat : ?2) & ?2 < ?1]]) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , LESS , MINUSSUCC , MINUSTYPE , MINUSZERO , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , SUCCNOTZERO , TYPES , ZEROMINUS , ZERONAT , forall , forsome , 0";
...
forcetheorem "WITNESSED" "WITNESSED , (|- ?P @ ?x) , ((?P @ ?x) & forsome @ [?P @ ?1]) , AND , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , NOT1 , ODDCHOICE , REFLEX , TYPES , forall , forsome , 0";
forcetheorem "EXP0" "EXP0 , (?x *`2 0) , 1 , EXP0 , 0";
forcetheorem "EXP2" "EXP2 , (?x *`2 ?y + ?z) , ((?x *`2 ?y) * ?x *`2 ?z) , EXP2 , 0";
forcetheorem "EXP1" "EXP1 , (?x *`2 1) , (Nat : ?x) , EXP1 , 0";
forcetheorem "TREMLEFT" "(TREMLEFT @ ?thm) , (?x ^+ ?y) , ((?thm *> (RIGHT @ LEFT @ TYPES) ** $ ?thm) => ?x ^+ ?y) , 0";
forcetheorem "TIMESTYPE" "TIMESTYPE , (?x * ?y) , (Nat : (Nat : ?x) * Nat : ?y) , TIMESTYPE , 0";
forcetheorem "EXP3" "EXP3 , (?x *`2 1 + ?y) , (?x * ?x *`2 ?y) , EXP1 , EXP2 , TIMESTYPE , TYPES , 0";
...
forcetheorem "MINUSCOMP" "MINUSCOMP , (?x - ?y) , (?x -! ?y) , MINUSCOMP , 0";
forcetheorem "EXP3s" "EXP3s , (?x *`2 ?y) , (TIMESCOMP => (RIGHT @ EXP3s) => ((RIGHT @ $ ZERONAT) ** EXP0) => ((RIGHT @ MAKESUCC) ** EXP3) => ?x *`2 ?y) , 0";
forcetheorem "DIVMOD" "DIVMOD , (Nat : ?n) , (((?n /! ?m) * ?m) + ?n %! ?m) , DIVMOD , 0";
forcetheorem "MAKESUCC" "MAKESUCC , ?n , (MAKESUCC0 => TYPENUMERAL => ?n) , 0";
forcetheorem "TYPENUMERAL" "TYPENUMERAL , ?n , (CASEINTRO <= REVPIVOT => (LEFT @ RIGHT @ ($ PLUSCOMP) ** PLUSID) => (REFLEX => ?n = ?n +! 0) || (Nat : ?n) , ?n) , CASEINTRO , HYP , PLUSCOMP , PLUSID , 0";
...
forcetheorem "MAKESUCC0" "MAKESUCC0 , (Nat : ?n) , ((?n =! 1 +! ?n -! 1) || (1 + ?n -! 1) , Nat : ?n) , CASEINTRO , EQ_COMP , HYP , MINUSCOMP , PLUSCOMP , PLUSTYPE , TYPES , 0";
forcetheorem "DIST" "DIST , (?x * ?y + ?z) , ((?x * ?y) + ?x * ?z) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , forall , 0";
forcetheorem "RL" "(RL @ ?thm) , (?p ^+ ?q) , ((?thm => ?p) ^+ ?thm => ?q) , 0";
forcetheorem "TIMESID" "TIMESID , (?x * 1) , (Nat : ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TIMESSUCC , TIMESZERO , TYPES , forall , 0";
...
forcetheorem "PLUSTYPE" "PLUSTYPE , (?x + ?y) , (Nat : (Nat : ?x) + Nat : ?y) , PLUSTYPE , 0";
forcetheorem "PLUSASSOC" "PLUSASSOC , ((?x + ?y) + ?z) , (?x + ?y + ?z) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , HYP , IF , INDUCTION , NONTRIV , NOT1 , ODDCHOICE , OR , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TYPES , forall , 0";
forcetheorem "RIGHT" "(RIGHT @ ?thm) , ?x , (((RIGHT1 @ ?thm) =>> RIGHT2 @ ?thm) => ?x) , 0";
forcetheorem "RIGHT1" "(RIGHT1 @ ?thm) , (?p ^+ ?q) , (?p ^+ ?thm => ?q) , 0";
forcetheorem "PLUSSPLIT0" "PLUSSPLIT0 , (Nat : ?n) , ((?n /! 2) + (?n /! 2) +! ?n %! 2) , AND , BOOLDEF , CASEINTRO , DIVMOD , EQBOOL , EQUATION , EQ_COMP , FNDIST , HYP , IF , INDUCTION , MINUSCOMP , NONTRIV , NOT1 , ODDCHOICE , ONENAT , OR , PLUSCOMP , PLUSID , PLUSMINUS , PLUSSUCC , PLUSTYPE , REFLEX , TIMESSUCC , TIMESTYPE , TIMESZERO , TYPES , forall , 0";
forcetheorem "PLUSSPLIT" "PLUSSPLIT , ?n , (PLUSSPLIT0 => TYPENUMERAL => ?n) , 0";
forcetheorem "PLUSID" "PLUSID , (?x + 0) , (Nat : ?x) , PLUSID , 0";
forcetheorem "PLUSCOMP" "PLUSCOMP , (?x + ?y) , (?x +! ?y) , PLUSCOMP , 0";
forcetheorem "UNTYPENUMERAL" "UNTYPENUMERAL , (Nat : ?n) , (PLUSID => PLUSCOMP <= ?n +! 0) , PLUSCOMP , PLUSID , 0";
forcetheorem "}backup" "backup , (Nat : ?n) , (PLUSID => PLUSCOMP <= ?n +! 0) , PLUSCOMP , PLUSID , 0";
forcetheorem "SPLITCOMP" "SPLITCOMP , (?m ^^ ?n) , (((RL @ SPLITCOMP) ** TIMESCOMP) => (EXP0 =>> (EXP1 *> UNTYPENUMERAL) =>> (RIGHT @ PLUSSPLIT) ** EXP2) => ?m ^^ ?n) , 0";
forcetheorem "ACK1" "ACK1 , (?m +++ 0 , ?n) , (?m + ?n) , ACK1 , 0";
forcetheorem "ACK2" "ACK2 , (?m +++ 1 , 0) , 0 , ACK2 , 0";
forcetheorem "ACK3" "ACK3 , (?m +++ (?n + 2) , 0) , 1 , ACK3 , 0";
forcetheorem "ACK4" "ACK4 , (?m +++ (?n + 1) , ?p + 1) , (?m +++ ?n , ?m +++ (?n + 1) , ?p) , ACK4 , 0";
...
adddefdep2 "ACK2" "0";
adddefdep2 "ACK1" "0";
adddefdep2 "SPLITCOMP" "0";
adddefdep2 "UNTYPENUMERAL" "0";
adddefdep2 "PLUSSPLIT" "0";
adddefdep2 "PLUSSPLIT0" "0";
adddefdep2 "DIVMOD" "0";
adddefdep2 "EXP3s" "0";
adddefdep2 "MAKESUCC" "0";
adddefdep2 "MAKESUCC0" "0";
...
adddefdep2 "PLUSID" "0";
adddefdep2 "PLUSSUCC" "0";
adddefdep2 "TIMESZERO" "0";
adddefdep2 "TIMESSUCC" "0";
adddefdep2 "ZEROMINUS" "0";
adddefdep2 "PLUSMINUS" "0";
adddefdep2 "MINUSZERO" "0";
adddefdep2 "MINUSSUCC" "0";
adddefdep2 "INDUCTION" "AND , forall , NOT1 , OR , IF , 0";
adddefdep2 "TYPEXPLUSLEFT" "0";
adddefdep2 "TYPEXTIMESLEFT" "0";
adddefdep2 "TYPEXMINUSLEFT" "0";
adddefdep2 "TYPEXPLUSRIGHT" "0";
adddefdep2 "TYPEXTIMESRIGHT" "0";
adddefdep2 "TYPEXMINUSRIGHT" "0";
adddefdep2 "INDSETUP" "forall , 0";
adddefdep2 "IND_TAC" "forall , 0";
adddefdep2 "SAMESUCC" "0";
adddefdep2 "ZEROCOMM" "0";
adddefdep2 "TIMESID" "0";
adddefdep2 "ONECOMM" "0";
adddefdep2 "ONEASSOC" "0";
adddefdep2 "PLUSCOMM" "0";
adddefdep2 "PLUSASSOC" "0";
adddefdep2 "DIST" "0";
adddefdep2 "COMMDIST" "0";
adddefdep2 "COMMTIMESZERO" "0";
adddefdep2 "COMMTIMESID" "0";
adddefdep2 "TIMESCOMM" "0";
adddefdep2 "TIMESASSOC" "0";
adddefdep2 "PLUSMINUS2" "0";
adddefdep2 "SELFMINUS" "0";
adddefdep2 "NOT_EQ" "NOT1 , NOT_EQ , 0";
adddefdep2 "LESS" "NOT1 , LESS , 0";
adddefdep2 "LESSCOMP" "NOT1 , LESS , 0";
adddefdep2 "LESSTYPE" "NOT1 , LESS , 0";
adddefdep2 "LESSSCIN" "NOT1 , LESS , 0";
adddefdep2 "TYPEXLESSLEFT" "NOT1 , LESS , 0";
adddefdep2 "TYPEXLESSRIGHT" "NOT1 , LESS , 0";
adddefdep2 "TYPEX" "0";
adddefdep2 "ZEROMINUS2" "0";
adddefdep2 "ZEROMIN" "NOT1 , LESS , 0";
adddefdep2 "PLUSCANCEL" "0";
adddefdep2 "LESSLEMMA1" "NOT1 , LESS , 0";
adddefdep2 "ZEROORSUCC" "forall , NOT1 , AND , OR , forsome , 0";
adddefdep2 "MINUSPLUS1" "0";
adddefdep2 "MINUSSUM" "0";
adddefdep2 "LESS_THAN_ONE" "NOT1 , LESS , 0";
adddefdep2 "BOTHZERO" "AND , 0";
adddefdep2 "SUB_SUCCS" "0";
adddefdep2 "SUB_SUCC_LEMMA" "0";
adddefdep2 "PRETRICHOTOMY" "ASSERT , NOT1 , AND , OR , 0";
adddefdep2 "ZERONOTONE" "0";
adddefdep2 "MINUSDIFFS" "0";
adddefdep2 "LESS_MONOTONE" "NOT1 , LESS , 0";
adddefdep2 "ZERO_LESS_SUCC" "NOT1 , LESS , 0";
adddefdep2 "LESS_SUCC" "NOT1 , AND , OR , LESS , 0";
adddefdep2 "TRICHOTOMY1" "NOT1 , AND , OR , LESS , 0";
adddefdep2 "NOT_LESS_THAN_SELF" "NOT1 , LESS , 0";
adddefdep2 "TRICHOTOMY2" "NOT1 , AND , OR , IF , LESS , 0";
adddefdep2 "COMPLETE_INDUCTION" "forall , NOT1 , AND , OR , IF , LESS , 0";
adddefdep2 "CI_TAC" "forall , 0";
adddefdep2 "NOT_IMP" "AND , NOT1 , OR , IF , 0";
adddefdep2 "LNP" "NOT1 , forall , forsome , AND , OR , IF , LESS , 0";
adddefdep2 "LNP_TAC" "NOT1 , forall , forsome , 0";
adddefdep2 "DESCENT" "forall , NOT1 , AND , OR , IF , forsome , LESS , 0";
adddefdep2 "WITNESSED" "AND , NOT1 , forall , forsome , ASSERT , 0";
addthmtextdep2 "ACK4" "ACK4 , 0";
addthmtextdep2 "ACK3" "ACK3 , 0";
addthmtextdep2 "ACK2" "ACK2 , 0";
addthmtextdep2 "ACK1" "ACK1 , 0";
addthmtextdep2 "SPLITCOMP" "RL , SPLITCOMP , TIMESCOMP , (?x ** ?y) , EXP0 , EXP1 , UNTYPENUMERAL , PLUSID , PLUSCOMP , RIGHT , RIGHT1 , RIGHT2 , PLUSSPLIT , PLUSSPLIT0 , TYPENUMERAL , CASEINTRO , REVPIVOT , LEFT_CASE , HYP , LEFT , LEFT1 , LEFT2 , (?x $ ?y) , REFLEX , EXP2 , 0";
addthmtextdep2 "EXP2" "EXP2 , 0";
addthmtextdep2 "PLUSSPLIT" "PLUSSPLIT , PLUSSPLIT0 , TYPENUMERAL , CASEINTRO , REVPIVOT , LEFT_CASE , HYP , LEFT , LEFT1 , LEFT2 , RIGHT , RIGHT1 , RIGHT2 , PLUSCOMP , (?x $ ?y) , PLUSID , (?x ** ?y) , REFLEX , 0";
addthmtextdep2 "TYPENUMERAL" "TYPENUMERAL , CASEINTRO , REVPIVOT , LEFT_CASE , HYP , LEFT , LEFT1 , LEFT2 , RIGHT , RIGHT1 , RIGHT2 , PLUSCOMP , (?x $ ?y) , PLUSID , (?x ** ?y) , REFLEX , 0";
...
addthmtextdep2 "PLUSSPLIT0" "PLUSSPLIT0 , 0";
addthmtextdep2 "RIGHT" "RIGHT , RIGHT1 , RIGHT2 , 0";
addthmtextdep2 "RIGHT2" "RIGHT2 , 0";
addthmtextdep2 "RIGHT1" "RIGHT1 , 0";
addthmtextdep2 "UNTYPENUMERAL" "UNTYPENUMERAL , PLUSID , PLUSCOMP , 0";
addthmtextdep2 "PLUSCOMP" "PLUSCOMP , 0";
addthmtextdep2 "PLUSID" "PLUSID , 0";
addthmtextdep2 "EXP1" "EXP1 , 0";
addthmtextdep2 "EXP0" "EXP0 , 0";
addthmtextdep2 "**" "(?x ** ?y) , 0";
addthmtextdep2 "TIMESCOMP" "TIMESCOMP , 0";
addthmtextdep2 "RL" "RL , 0";
addthmtextdep2 "DIVMOD" "DIVMOD , 0";
addthmtextdep2 "EXP3s" "TIMESCOMP , RIGHT , RIGHT1 , RIGHT2 , EXP3s , ZERONAT , (?x $ ?y) , EXP0 , (?x ** ?y) , MAKESUCC , MAKESUCC0 , TYPENUMERAL , CASEINTRO , REVPIVOT , LEFT_CASE , HYP , LEFT , LEFT1 , LEFT2 , PLUSCOMP , PLUSID , REFLEX , EXP3 , 0";
addthmtextdep2 "EXP3" "EXP3 , 0";
addthmtextdep2 "MAKESUCC" "MAKESUCC , MAKESUCC0 , TYPENUMERAL , CASEINTRO , REVPIVOT , LEFT_CASE , HYP , LEFT , LEFT1 , LEFT2 , RIGHT , RIGHT1 , RIGHT2 , PLUSCOMP , (?x $ ?y) , PLUSID , (?x ** ?y) , REFLEX , 0";
addthmtextdep2 "MAKESUCC0" "MAKESUCC0 , 0";
...
addthmtextdep2 "PLUSSUCC" "PLUSSUCC , 0";
addthmtextdep2 "TIMESZERO" "TIMESZERO , 0";
addthmtextdep2 "TIMESSUCC" "TIMESSUCC , 0";
addthmtextdep2 "ZEROMINUS" "ZEROMINUS , 0";
addthmtextdep2 "PLUSMINUS" "PLUSMINUS , 0";
addthmtextdep2 "MINUSZERO" "MINUSZERO , 0";
addthmtextdep2 "MINUSSUCC" "MINUSSUCC , 0";
addthmtextdep2 "SAMESUCC" "SAMESUCC , 0";
addthmtextdep2 "ZEROCOMM" "ZEROCOMM , 0";
addthmtextdep2 "TIMESID" "TIMESID , 0";
addthmtextdep2 "ONECOMM" "ONECOMM , 0";
addthmtextdep2 "ONEASSOC" "ONEASSOC , 0";
...
addthmtextdep2 "COMMTIMESZERO" "COMMTIMESZERO , 0";
addthmtextdep2 "COMMTIMESID" "COMMTIMESID , 0";
addthmtextdep2 "TIMESCOMM" "TIMESCOMM , 0";
addthmtextdep2 "TIMESASSOC" "TIMESASSOC , 0";
addthmtextdep2 "PLUSMINUS2" "PLUSMINUS2 , 0";
addthmtextdep2 "SELFMINUS" "SELFMINUS , 0";
...
addthmtextdep2 "LESSSCIN" "LESSSCIN , LESS , NOT1 , 0";
addthmtextdep2 "INDUCTION" "INDUCTION , forall , IF , NOT1 , OR , AND , 0";
addthmtextdep2 "IND_TAC" "IND_TAC , forall , STRONG_EVERYWHERE_CASE , EVERYWHERE2 , EVERYWHERE_INFIX , EVERYWHERE_PREFIX , EVERYWHERE_ABS , INDUCTION , IF , NOT1 , OR , AND , INDSETUP , TYPEXLESSRIGHT , LESS , TYPEXLESSLEFT , TYPEXMINUSRIGHT , TYPEXTIMESRIGHT , TYPEXPLUSRIGHT , TYPEXMINUSLEFT , TYPEXTIMESLEFT , TYPEXPLUSLEFT , VALUE , TYPEX , RL , 0";
addthmtextdep2 "ZEROMINUS2" "ZEROMINUS2 , 0";
addthmtextdep2 "ZEROMIN" "ZEROMIN , LESS , NOT1 , 0";
addthmtextdep2 "PLUSCANCEL" "PLUSCANCEL , 0";
addthmtextdep2 "LESSLEMMA1" "LESSLEMMA1 , LESS , NOT1 , 0";
addthmtextdep2 "ZEROORSUCC" "ZEROORSUCC , forall , forsome , NOT1 , OR , AND , 0";
addthmtextdep2 "MINUSPLUS1" "MINUSPLUS1 , 0";
addthmtextdep2 "MINUSSUM" "MINUSSUM , 0";
addthmtextdep2 "LESS_THAN_ONE" "LESS_THAN_ONE , LESS , NOT1 , 0";
addthmtextdep2 "BOTHZERO" "BOTHZERO , AND , 0";
addthmtextdep2 "SUB_SUCCS" "SUB_SUCCS , 0";
addthmtextdep2 "SUB_SUCC_LEMMA" "SUB_SUCC_LEMMA , 0";
addthmtextdep2 "PRETRICHOTOMY" "PRETRICHOTOMY , AND , OR , NOT1 , ASSERT , 0";
addthmtextdep2 "ZERONOTONE" "ZERONOTONE , 0";
addthmtextdep2 "MINUSDIFFS" "MINUSDIFFS , 0";
addthmtextdep2 "LESS_MONOTONE" "LESS_MONOTONE , LESS , NOT1 , 0";
addthmtextdep2 "ZERO_LESS_SUCC" "ZERO_LESS_SUCC , LESS , NOT1 , 0";
addthmtextdep2 "LESS_SUCC" "LESS_SUCC , LESS , NOT1 , OR , AND , 0";
addthmtextdep2 "TRICHOTOMY1" "TRICHOTOMY1 , LESS , NOT1 , OR , AND , 0";
addthmtextdep2 "NOT_LESS_THAN_SELF" "NOT_LESS_THAN_SELF , LESS , NOT1 , 0";
addthmtextdep2 "TRICHOTOMY2" "TRICHOTOMY2 , LESS , NOT1 , IF , OR , AND , 0";
addthmtextdep2 "COMPLETE_INDUCTION" "COMPLETE_INDUCTION , forall , LESS , NOT1 , IF , OR , AND , 0";
addthmtextdep2 "TYPEXLESSRIGHT" "TYPEXLESSRIGHT , LESS , NOT1 , 0";
addthmtextdep2 "TYPEXLESSLEFT" "TYPEXLESSLEFT , LESS , NOT1 , 0";
addthmtextdep2 "TYPEXMINUSRIGHT" "TYPEXMINUSRIGHT , 0";
addthmtextdep2 "TYPEXTIMESRIGHT" "TYPEXTIMESRIGHT , 0";
addthmtextdep2 "TYPEXPLUSRIGHT" "TYPEXPLUSRIGHT , 0";
addthmtextdep2 "TYPEXMINUSLEFT" "TYPEXMINUSLEFT , 0";
addthmtextdep2 "TYPEXTIMESLEFT" "TYPEXTIMESLEFT , 0";
addthmtextdep2 "TYPEXPLUSLEFT" "TYPEXPLUSLEFT , 0";
addthmtextdep2 "VALUE" "VALUE , 0";
addthmtextdep2 "TYPEX" "TYPEXLESSRIGHT , LESS , NOT1 , TYPEXLESSLEFT , TYPEXMINUSRIGHT , TYPEXTIMESRIGHT , TYPEXPLUSRIGHT , TYPEXMINUSLEFT , TYPEXTIMESLEFT , TYPEXPLUSLEFT , VALUE , STRONG_EVERYWHERE_CASE , EVERYWHERE2 , EVERYWHERE_INFIX , EVERYWHERE_PREFIX , EVERYWHERE_ABS , TYPEX , RL , 0";
addthmtextdep2 "INDSETUP" "INDSETUP , forall , TYPEXLESSRIGHT , LESS , NOT1 , TYPEXLESSLEFT , TYPEXMINUSRIGHT , TYPEXTIMESRIGHT , TYPEXPLUSRIGHT , TYPEXMINUSLEFT , TYPEXTIMESLEFT , TYPEXPLUSLEFT , VALUE , STRONG_EVERYWHERE_CASE , EVERYWHERE2 , EVERYWHERE_INFIX , EVERYWHERE_PREFIX , EVERYWHERE_ABS , TYPEX , RL , 0";
addthmtextdep2 "CI_TAC" "CI_TAC , forall , STRONG_EVERYWHERE_CASE , EVERYWHERE2 , EVERYWHERE_INFIX , EVERYWHERE_PREFIX , EVERYWHERE_ABS , COMPLETE_INDUCTION , LESS , NOT1 , IF , OR , AND , INDSETUP , TYPEXLESSRIGHT , TYPEXLESSLEFT , TYPEXMINUSRIGHT , TYPEXTIMESRIGHT , TYPEXPLUSRIGHT , TYPEXMINUSLEFT , TYPEXTIMESLEFT , TYPEXPLUSLEFT , VALUE , TYPEX , RL , 0";
addthmtextdep2 "NOT_IMP" "NOT_IMP , IF , NOT1 , OR , AND , 0";
...
addthmtextdep2 "LNP" "LNP , forsome , forall , NOT1 , LESS , IF , OR , AND , 0";
addthmtextdep2 "LNP_TAC" "LNP_TAC , forsome , forall , NOT1 , STRONG_EVERYWHERE_CASE , EVERYWHERE2 , EVERYWHERE_INFIX , EVERYWHERE_PREFIX , EVERYWHERE_ABS , LNP , LESS , IF , OR , AND , 0";
addthmtextdep2 "LESS" "LESS , NOT1 , 0";
addthmtextdep2 "OR" "OR , NOT1 , AND , 0";
addthmtextdep2 "IF" "IF , NOT1 , OR , AND , 0";
addthmtextdep2 "DESCENT" "DESCENT , forall , NOT1 , forsome , LESS , AND , IF , OR , 0";
...
addthmtextdep2 "WITNESSED" "WITNESSED , ASSERT , forsome , forall , NOT1 , AND , 0";
quit();
