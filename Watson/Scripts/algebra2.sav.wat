...
forcetheorem "}backup" "backup , (?x < ?x) , false , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , NOT1 , ODDCHOICE , REFLEX , ABSOLUTE , COMP_NAT , COMP_PLUS , MINUSTYPE , PLUSASSOC , PLUSCOMM , PLUSID , PLUSTYPE , PM , TYPES , LESS , 0";
