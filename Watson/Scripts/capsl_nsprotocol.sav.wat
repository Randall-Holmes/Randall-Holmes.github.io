declareconstant "NS_B_THEOREM5";
declareconstant "NS_B_THEOREM4";
declareconstant "NS_B_THEOREM4A";
declareconstant "NS_B_THEOREM3";
declareconstant "PRE_NS_B_THEOREM3";
declareconstant "NS_B_THEOREM2";
declareconstant "GOAL_2_B";
declareconstant "P_16A";
declareconstant "NS_B_THM2";
declareconstant "NS_B_THEOREM1";
declareconstant "NS_A_THEOREM6";
declareconstant "NS_A_THEOREM6B";
declareconstant "NS_A_THEOREM6A";
declareconstant "NS_A_THEOREM5";
declareconstant "NS_A_THEOREM5E";
declareconstant "PRE_NS_A_THM5E_SAYS";
declareconstant "PRE_NS_A_THM5E_SAID";
declareconstant "NS_A_THEOREM5D";
declareconstant "NS_A_THEOREM5C";
declareconstant "NS_A_THEOREM5B";
declareconstant "NS_A_THEOREM5A";
declareconstant "NS_A_THEOREM4";
declareconstant "NS_A_THEOREM3";
declareconstant "NS_A_THEOREM2";
declareconstant "GOAL_2";
declareconstant "BELIEVE2LEMMA";
declareconstant "NS_A_TH2";
declareconstant "NS_A_THEOREM1";
declareconstant "SAYS_REM_TLABEL";
declareconstant "SAID_REM_TLABEL";
declareconstant "TACTIC_IMP";
declareconstant "TACTIC_AND_BELIEF";
declareconstant "TACTIC_IMP_BELIEF";
declareconstant "BELIEVE_IS_BELIEVE_TRUE1";
declareconstant "BELIEVE_IS_BELIEVE_TRUE";
...
forcetheorem "BELIEVE_IS_BELIEVE_TRUE" "BELIEVE_IS_BELIEVE_TRUE , ((?P `BELIEVES ?x) -> ?P `BELIEVES true) , true , BASSOC , BDIS , BELIEVES_BELIEVES_IS_BELIEVES , BELIEVE_AND , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , TYPES , 0";
...
forcetheorem "NS_A_TH2" "NS_A_TH2 , (A `BELIEVES S `SAID Na , (Principal : B) , (shared_key @ A , B , Kab) , (Fresh @ Skey : Kab) , Message : ?y) , true , NS_A_TH2 , 0";
forcetheorem "AXIOM_02" "AXIOM_02 , ((?P `BELIEVES ?si) -> ?P `BELIEVES ?P `BELIEVES ?si) , true , AXIOM_02 , 0";
forcetheorem "BELIEVE2LEMMA" "BELIEVE2LEMMA , (?A `BELIEVES ?x) , ((?A `BELIEVES ?x) & ?A `BELIEVES ?A `BELIEVES ?x) , AXIOM_02 , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , TYPES , 0";
forcetheorem "}NS_A_THEOREM1" "NS_A_THEOREM1 , (A `BELIEVES A `RECEIVED Kas `se Na , (Principal : B) , ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y) , true , AXIOM_01 , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , P_12A , P_9 , TYPES , 0";
forcetheorem "P_15" "P_15 , (A `BELIEVES (A `RECEIVED Kas `se Na , ?x) -> A `RECEIVED_FROM S , Kas `se Na , ?x) , true , P_15 , 0";
forcetheorem "NS_A_THEOREM1" "NS_A_THEOREM1 , (A `BELIEVES A `RECEIVED Kas `se Na , (Principal : B) , ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y) , true , AXIOM_01 , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , P_12A , P_9 , TYPES , 0";
forcetheorem "GOAL_2" "GOAL_2 , (A `BELIEVES (S `SAID Na , (Principal : B) , ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y) & S `SEES Kas) , true , AXIOM_01 , AXIOM_03A , BASSOC , BDIS , BELIEVE_AND , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , P_12A , P_15 , P_4A , P_9 , TYPES , 0";
...
forcetheorem "NS_A_THEOREM3" "NS_A_THEOREM3 , (A `BELIEVES Fresh @ Na , (Principal : B) , ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y) , true , AXIOM_01 , AXIOM_17A , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NECESSITATION , NTYPE , PROP , P_1A , TYPES , 0";
...
forcetheorem "SAYS_REM_TLABEL" "SAYS_REM_TLABEL , (?x `SAYS Message : ?y) , (?x `SAYS ?y) , SAYS_TYPE , TYPES , 0";
forcetheorem "P_2A" "P_2A , (A `BELIEVES S `CONTROLS shared_key @ A , B , Kab) , true , P_2A , 0";
forcetheorem "NS_A_THEOREM5" "NS_A_THEOREM5 , (A `BELIEVES shared_key @ A , B , Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_15A , AXIOM_16 , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , MESSAGE_TYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_2A , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SAID_TYPE , SAYS_AXIOM , SAYS_TYPE , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_A_THEOREM2" "NS_A_THEOREM2 , (A `BELIEVES S `SAID Na , (Principal : B) , ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_4A , P_9 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_A_THEOREM5B" "NS_A_THEOREM5B , (A `BELIEVES S `SAID Na) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_4A , P_9 , SAID_IMP1 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_A_THEOREM5D" "NS_A_THEOREM5D , (A `BELIEVES S `SAID Principal : B) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "PRE_NS_A_THM5E_SAID" "PRE_NS_A_THM5E_SAID , (S `SAID ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y_5) , (S `SAID (shared_key @ A , B , Kab) , (Fresh @ Skey : Kab) , Message : ?y_5) , BASSOC , BDIS , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , MESSAGE_TYPE , NTYPE , PROP , SAID_AXIOM , SAID_TYPE , TYPES , 0";
forcetheorem "NS_A_THEOREM6A" "NS_A_THEOREM6A , (A `BELIEVES S `SAID shared_key @ A , B , Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , MESSAGE_TYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SAID_TYPE , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_A_THEOREM4" "NS_A_THEOREM4 , (A `BELIEVES S `SAYS Na , (Principal : B) , ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y) , true , AXIOM_01 , AXIOM_03A , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_4A , P_9 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_A_THEOREM5A" "NS_A_THEOREM5A , (A `BELIEVES S `SAYS Na) , true , AXIOM_01 , AXIOM_03A , AXIOM_15A , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_4A , P_9 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_A_THEOREM5C" "NS_A_THEOREM5C , (A `BELIEVES S `SAYS Principal : B) , true , AXIOM_01 , AXIOM_03A , AXIOM_15A , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SAYS_AXIOM , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "PRE_NS_A_THM5E_SAYS" "PRE_NS_A_THM5E_SAYS , (S `SAYS ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Message : ?y_2) , (S `SAYS (shared_key @ A , B , Kab) , (Fresh @ Skey : Kab) , Message : ?y_2) , BASSOC , BDIS , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , MESSAGE_TYPE , NTYPE , PROP , SAYS_AXIOM , SAYS_TYPE , TYPES , 0";
forcetheorem "SAYS_AXIOM" "SAYS_AXIOM , (?P `SAYS ?x , ?y) , ((?P `SAYS ?x) & ?P `SAYS ?y) , SAYS_AXIOM , 0";
forcetheorem "NS_A_THEOREM5E" "NS_A_THEOREM5E , (A `BELIEVES S `SAYS shared_key @ A , B , Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_15A , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , MESSAGE_TYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SAID_TYPE , SAYS_AXIOM , SAYS_TYPE , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
...
forcetheorem "NS_A_THEOREM6B" "NS_A_THEOREM6B , (A `BELIEVES S `SAYS Fresh @ Skey : Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_15A , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , MESSAGE_TYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SAID_TYPE , SAYS_AXIOM , SAYS_TYPE , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "AXIOM_16" "AXIOM_16 , (((?P `CONTROLS ?si) & ?P `SAYS ?si) -> ?si) , true , AXIOM_16 , 0";
forcetheorem "NS_A_THEOREM6" "NS_A_THEOREM6 , (A `BELIEVES Fresh @ Skey : Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_15A , AXIOM_16 , AXIOM_17A , AXIOM_19 , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , MESSAGE_TYPE , NECESSITATION , NTYPE , PROP , P_12A , P_15 , P_1A , P_3A , P_4A , P_9 , SAID_AXIOM , SAID_IMP1 , SAID_TYPE , SAYS_AXIOM , SAYS_TYPE , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
...
forcetheorem "NS_B_THM2" "NS_B_THM2 , (B `BELIEVES S `SAID (shared_key @ A , B , Kab) , (Fresh @ Skey : Kab) , Principal : A) , true , NS_B_THM2 , 0";
forcetheorem "}NS_B_THEOREM1" "NS_B_THEOREM1 , (B `BELIEVES B `RECEIVED Kbs `se ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) , true , AXIOM_01 , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , P_10 , P_13B , TYPES , 0";
forcetheorem "P_16A" "P_16A , (B `BELIEVES (B `RECEIVED Kbs `se ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , ?x) -> B `RECEIVED_FROM S , Kbs `se ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , ?x) , true , P_16A , 0";
forcetheorem "}Useful_Lemma" "Useful_Lemma , (B `BELIEVES B `RECEIVED Kbs `se ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) , (B `BELIEVES B `RECEIVED_FROM S , Kbs `se ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) , BELIEVE_TYPE , TYPES , PROP , BASSOC , BDIS , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , NTYPE , AXIOM_01 , IDEF , P_10 , P_13B , BELIEVE_AND , DASSOC , P_16A , 0";
...
forcetheorem "NS_B_THEOREM1" "NS_B_THEOREM1 , (B `BELIEVES B `RECEIVED Kbs `se ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) , true , AXIOM_01 , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , P_10 , P_13B , TYPES , 0";
forcetheorem "GOAL_2_B" "GOAL_2_B , (B `BELIEVES (S `SAID ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) & S `SEES Kbs) , true , AXIOM_01 , AXIOM_03A , BASSOC , BDIS , BELIEVE_AND , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , NTYPE , PROP , P_10 , P_13B , P_16A , P_4B , TYPES , 0";
forcetheorem "TACTIC_IMP" "TACTIC_IMP , (?x -> ?y) , (true -> ?x -> ?y) , BDIS , BID , BID2 , BSYM , BTYPE , DDIS , DIDEM , DSYM , DXM , FDEF , IDEF , IMPTYPE , NTYPE , PROP , TYPES , 0";
forcetheorem "BELIEVE_IS_BELIEVE_TRUE1" "BELIEVE_IS_BELIEVE_TRUE1 , ((?P `BELIEVES ?x) -> ?P `BELIEVES true) , true , BDIS , BID , BID2 , BSYM , BTYPE , DDIS , DIDEM , DSYM , DXM , FDEF , IDEF , NECESSITATION , NTYPE , PROP , TYPES , 0";
...
forcetheorem "SAID_REM_TLABEL" "SAID_REM_TLABEL , (?x `SAID Message : ?y) , (?x `SAID ?y) , SAID_TYPE , TYPES , 0";
...
forcetheorem "NS_B_THEOREM2" "NS_B_THEOREM2 , (B `BELIEVES S `SAID ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_10 , P_13B , P_16A , P_4B , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "PRE_NS_B_THEOREM3" "PRE_NS_B_THEOREM3 , (S `SAID ((shared_key @ A , B , Kab) , Fresh @ Skey : Kab) , Principal : A) , (S `SAID (shared_key @ A , B , Kab) , (Fresh @ Skey : Kab) , Principal : A) , BASSOC , BDIS , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , NTYPE , PROP , SAID_AXIOM , TYPES , 0";
forcetheorem "SAID_AXIOM" "SAID_AXIOM , (?P `SAID ?x , ?y) , ((?P `SAID ?x) & ?P `SAID ?y) , SAID_AXIOM , 0";
forcetheorem "NS_B_THEOREM3" "NS_B_THEOREM3 , (B `BELIEVES S `SAID shared_key @ A , B , Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_10 , P_13B , P_16A , P_4B , SAID_AXIOM , SAID_IMP1 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "NS_B_THEOREM4A" "NS_B_THEOREM4A , (B `BELIEVES S `SAID (Fresh @ Skey : Kab) , Principal : A) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_10 , P_13B , P_16A , P_4B , SAID_AXIOM , SAID_IMP1 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "TACTIC_AND_BELIEF" "TACTIC_AND_BELIEF , (?x `BELIEVES ?y) , (true & ?x `BELIEVES ?y) , BASSOC , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , NTYPE , PROP , TYPES , 0";
...
forcetheorem "NS_B_THEOREM4" "NS_B_THEOREM4 , (B `BELIEVES S `SAID Fresh @ Skey : Kab) , true , AXIOM_01 , AXIOM_03A , AXIOM_20 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_IMP , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DASSOC , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NECESSITATION , NTYPE , PROP , P_10 , P_13B , P_16A , P_4B , SAID_AXIOM , SAID_IMP1 , SHARED_KEY_IMP_SEES_KEY , TYPES , 0";
forcetheorem "}backup" "backup , (B `BELIEVES S `SAID Fresh @ Skey : Kab) , true , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , DDIS , DIDEM , DSYM , DXM , FDEF , IDEF , NTYPE , PROP , TYPES , NECESSITATION , SAID_IMP1 , BASSOC , CTYPE , DTYPE , GR , AXIOM_01 , AXIOM_03A , AXIOM_20 , BELIEVE_AND , BELIEVE_IMP , DASSOC , IMPTYPE , P_10 , P_13B , P_16A , P_4B , SAID_AXIOM , SHARED_KEY_IMP_SEES_KEY , 0";
...
forcetheorem "TACTIC_IMP_BELIEF" "TACTIC_IMP_BELIEF , (?x `BELIEVES ?y) , (true -> ?x `BELIEVES ?y) , BDIS , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , DDIS , DIDEM , DSYM , DXM , FDEF , IDEF , NTYPE , PROP , TYPES , 0";
forcetheorem "NS_B_THEOREM5" "NS_B_THEOREM5 , (B `BELIEVES B `RECEIVED Kab `se Nb - 1) , true , AXIOM_01 , BASSOC , BDIS , BELIEVE_AND , BELIEVE_TYPE , BID , BID2 , BSYM , BTYPE , CTYPE , DDIS , DIDEM , DSYM , DTYPE , DXM , FDEF , GR , IDEF , IMPTYPE , NTYPE , PROP , P_10 , P_11 , P_14 , TYPES , 0";
adddef "PROP" "|-";
adddef "True" "True";
adddef "Bool" "Bool";
adddef "UNIONTYPE" "<+>";
...
setprogram "p2" "p2";
setprogram "p1" "p1";
adddefdep2 "NS_B_THEOREM5" "0";
adddefdep2 "NS_B_THEOREM4" "0";
adddefdep2 "NS_B_THEOREM4A" "0";
adddefdep2 "NS_B_THEOREM3" "0";
adddefdep2 "PRE_NS_B_THEOREM3" "0";
adddefdep2 "NS_B_THEOREM2" "0";
adddefdep2 "GOAL_2_B" "0";
adddefdep2 "P_16A" "0";
adddefdep2 "NS_B_THM2" "0";
adddefdep2 "NS_B_THEOREM1" "0";
adddefdep2 "NS_A_THEOREM6" "0";
adddefdep2 "NS_A_THEOREM6B" "0";
adddefdep2 "NS_A_THEOREM6A" "0";
adddefdep2 "NS_A_THEOREM5" "0";
adddefdep2 "NS_A_THEOREM5E" "0";
adddefdep2 "PRE_NS_A_THM5E_SAYS" "0";
adddefdep2 "PRE_NS_A_THM5E_SAID" "0";
adddefdep2 "NS_A_THEOREM5D" "0";
adddefdep2 "NS_A_THEOREM5C" "0";
adddefdep2 "NS_A_THEOREM5B" "0";
adddefdep2 "NS_A_THEOREM5A" "0";
adddefdep2 "NS_A_THEOREM4" "0";
adddefdep2 "NS_A_THEOREM3" "0";
adddefdep2 "NS_A_THEOREM2" "0";
adddefdep2 "GOAL_2" "0";
adddefdep2 "BELIEVE2LEMMA" "0";
adddefdep2 "NS_A_TH2" "0";
adddefdep2 "NS_A_THEOREM1" "0";
adddefdep2 "SAYS_REM_TLABEL" "0";
adddefdep2 "SAID_REM_TLABEL" "0";
adddefdep2 "TACTIC_IMP" "0";
adddefdep2 "TACTIC_AND_BELIEF" "0";
adddefdep2 "TACTIC_IMP_BELIEF" "0";
adddefdep2 "BELIEVE_IS_BELIEVE_TRUE1" "0";
adddefdep2 "BELIEVE_IS_BELIEVE_TRUE" "0";
adddefdep2 "P_15" "0";
adddefdep2 "P_14" "0";
adddefdep2 "P_13B" "0";
adddefdep2 "P_12A" "0";
...
adddefdep2 "TYPES" "0";
addthmtextdep2 "NS_B_THEOREM5" "NS_B_THEOREM5 , 0";
addthmtextdep2 "NS_B_THEOREM4" "NS_B_THEOREM4 , 0";
addthmtextdep2 "NS_B_THEOREM4A" "NS_B_THEOREM4A , 0";
addthmtextdep2 "NS_B_THEOREM3" "NS_B_THEOREM3 , 0";
addthmtextdep2 "PRE_NS_B_THEOREM3" "PRE_NS_B_THEOREM3 , 0";
addthmtextdep2 "NS_B_THEOREM2" "NS_B_THEOREM2 , 0";
addthmtextdep2 "GOAL_2_B" "GOAL_2_B , 0";
addthmtextdep2 "P_16A" "P_16A , 0";
addthmtextdep2 "NS_B_THM2" "NS_B_THM2 , 0";
addthmtextdep2 "NS_B_THEOREM1" "NS_B_THEOREM1 , 0";
addthmtextdep2 "NS_A_THEOREM6" "NS_A_THEOREM6 , 0";
addthmtextdep2 "NS_A_THEOREM6B" "NS_A_THEOREM6B , 0";
addthmtextdep2 "NS_A_THEOREM6A" "NS_A_THEOREM6A , 0";
addthmtextdep2 "NS_A_THEOREM5" "NS_A_THEOREM5 , 0";
addthmtextdep2 "NS_A_THEOREM5E" "NS_A_THEOREM5E , 0";
addthmtextdep2 "PRE_NS_A_THM5E_SAYS" "PRE_NS_A_THM5E_SAYS , 0";
addthmtextdep2 "PRE_NS_A_THM5E_SAID" "PRE_NS_A_THM5E_SAID , 0";
addthmtextdep2 "NS_A_THEOREM5D" "NS_A_THEOREM5D , 0";
addthmtextdep2 "NS_A_THEOREM5C" "NS_A_THEOREM5C , 0";
addthmtextdep2 "NS_A_THEOREM5B" "NS_A_THEOREM5B , 0";
addthmtextdep2 "NS_A_THEOREM5A" "NS_A_THEOREM5A , 0";
addthmtextdep2 "NS_A_THEOREM4" "NS_A_THEOREM4 , 0";
addthmtextdep2 "NS_A_THEOREM3" "NS_A_THEOREM3 , 0";
addthmtextdep2 "NS_A_THEOREM2" "NS_A_THEOREM2 , 0";
addthmtextdep2 "GOAL_2" "GOAL_2 , 0";
addthmtextdep2 "BELIEVE2LEMMA" "BELIEVE2LEMMA , 0";
addthmtextdep2 "NS_A_TH2" "NS_A_TH2 , 0";
addthmtextdep2 "NS_A_THEOREM1" "NS_A_THEOREM1 , 0";
addthmtextdep2 "SAYS_REM_TLABEL" "SAYS_REM_TLABEL , 0";
addthmtextdep2 "SAID_REM_TLABEL" "SAID_REM_TLABEL , 0";
addthmtextdep2 "TACTIC_IMP" "TACTIC_IMP , 0";
addthmtextdep2 "TACTIC_AND_BELIEF" "TACTIC_AND_BELIEF , 0";
addthmtextdep2 "TACTIC_IMP_BELIEF" "TACTIC_IMP_BELIEF , 0";
addthmtextdep2 "BELIEVE_IS_BELIEVE_TRUE1" "BELIEVE_IS_BELIEVE_TRUE1 , 0";
addthmtextdep2 "BELIEVE_IS_BELIEVE_TRUE" "BELIEVE_IS_BELIEVE_TRUE , 0";
