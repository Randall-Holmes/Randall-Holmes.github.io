...
declareconstant "ONE_ASSIGN_TYPE";
declareconstant "ONEASSIGNTYPE";
declareconstant "ONEASSIGN_1";
declareconstant "ONE_ASSIGN_1";
declareconstant "ONEASSIGN";
declareconstant "ONE_ASSIGN";
declareconstant "MASSIGN";
declareconstant "MASSIGNTYPE";
declareconstant "REXPSTATEDATA";
declareconstant "MASSIGNDEF";
declareconstant "REXP4";
...
forcetheorem "STATERETRACT" "STATERETRACT , [data : ?s @ address : ?1] , [data : [data : ?s @ address : ?2] @ address : ?1] , TYPES , 0";
...
forcetheorem "COMMANDRETRACT" "COMMANDRETRACT , [((state : ?1) = [error]) || [error] , state : ?c @ state : ?1] , [((state : ?1) = [error]) || [error] , state : [((state : ?2) = [error]) || [error] , state : ?c @ state : ?2] @ state : ?1] , EQBOOL , TYPES , 0";
...
forcetheorem "REXPRETRACT" "REXPRETRACT , [data : ?x @ state : ?1] , [data : [data : ?x @ state : ?2] @ state : ?1] , TYPES , 0";
forcetheorem "}rexp" "rexp , (rexp : ?x) , [data : ?x @ state : ?1] , TYPES , rexp , 0";
forcetheorem "ARROWRETRACT" "ARROWRETRACT , [?t2 : ?f @ ?t1 : ?1] , [?t2 : [?t2 : ?f @ ?t1 : ?2] @ ?t1 : ?1] , TYPES , 0";
forcetheorem "REXP_STATE_RETRACT" "REXP_STATE_RETRACT , [rexp : ?x @ address : ?1] , [rexp : [rexp : ?x @ address : ?2] @ address : ?1] , TYPES , 0";
forcetheorem "rexp_state" "rexp_state , (rexp_state : ?x) , [rexp : ?x @ address : ?1] , TYPES , rexp_state , 0";
forcetheorem "}rexp_state" "rexp_state , (rexp_state : ?x) , [rexp : ?x @ address : ?1] , TYPES , rexp_state , 0";
forcetheorem "con" "con , (con @ ?x) , [data : ?x] , con , 0";
forcetheorem "REXP1" "REXP1 , (con @ ?x) , (rexp : con @ ?x) , TYPES , con , rexp , 0";
forcetheorem "var" "var , (var @ ?u) , [(state : ?1) @ address : ?u] , var , 0";
forcetheorem "REXP2" "REXP2 , (var @ ?u) , (rexp : var @ ?u) , TYPES , rexp , state , var , 0";
...
forcetheorem "EXPPLUS" "EXPPLUS , (?x !+! ?y) , [(Nat : (rexp : ?x) @ ?1) + Nat : (rexp : ?y) @ ?1] , EXPPLUS , 0";
forcetheorem "REXP3" "REXP3 , (?x !+! ?y) , (rexp : ?x !+! ?y) , COMPPLUSTYPE , COMP_PLUS , EXPPLUS , NATDATA , PLUSTYPE , TYPES , rexp , 0";
forcetheorem "REXP00" "REXP00 , (rexp : ?x) , [data : ?x @ state : ?1] , TYPES , rexp , 0";
forcetheorem "ARRAYSUB" "ARRAYSUB , (?v .. ?i) , [(state : ?1) @ (address : ?v) +++ (rexp : ?i) @ state : ?1] , ARRAYSUB , 0";
forcetheorem "REXP4" "REXP4 , (?v .. ?i) , (rexp : (address : ?v) .. rexp : ?i) , ARRAYSUB , TYPES , rexp , state , 0";
forcetheorem "UNEVAL_TAC" "(UNEVAL_TAC @ ?f) , ?x , ((BOTH_CASES @ EVAL) => FNDIST => (UNEVAL @ ?f) => ?x) , 0";
forcetheorem "rexp" "rexp , (rexp : ?x) , [data : ?x @ state : ?1] , TYPES , rexp , 0";
forcetheorem "REXP0a" "REXP0a , ((rexp : ?x) @ state : ?s) , (data : ?x @ state : ?s) , TYPES , rexp , 0";
forcetheorem "REXPSTATEDATA" "REXPSTATEDATA , (data : ((rexp_state : ?s) @ address : ?a) @ state : ?x) , (((rexp_state : ?s) @ address : ?a) @ state : ?x) , TYPES , rexp , rexp_state , 0";
forcetheorem "}MASSIGNTYPE" "MASSIGNTYPE , (?a =:: ?s) , (command : (lexp : ?a) =:: rexp_state : ?s) , MASSIGNDEF , TYPES , state , EQBOOL , rexp , rexp_state , FNDIST , command , 0";
forcetheorem "STATETYPE" "STATETYPE , (state : ?s) , [data : ?s @ address : ?1] , TYPES , state , 0";
forcetheorem "MASSIGNDEF" "MASSIGNDEF , (?a =:: ?s) , [((state : ?1) = [error]) || [error] , [((lexp : ?a) @ address : ?2) || (((rexp_state : ?s) @ address : ?2) @ state : ?1) , (state : ?1) @ address : ?2]] , MASSIGNDEF , 0";
forcetheorem "MASSIGN" "MASSIGN , ((?a =:: ?s) @ ?t) , [((~ (state : ?t) = [error]) & (lexp : ?a) @ address : ?1) || (((rexp_state : ?s) @ address : ?1) @ ?t) , (state : ?t) @ ?1] , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , MASSIGNDEF , NONTRIV , NOT1 , REFLEX , TYPES , rexp , rexp_state , state , 0";
...
forcetheorem "ONE_ASSIGN_1" "ONE_ASSIGN_1 , (((?v =: ?x) @ ?s) @ ?u) , (((~ (state : ?s) = [error]) & (address : ?u) = address : ?v) || ((rexp : ?x) @ ?s) , (state : ?s) @ ?u) , AND , ARROWTYPE , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , MASSIGNDEF , NONTRIV , NOT1 , ONE_ASSIGN , REFLEX , TYPES , lexp , rexp , rexp_state , state , 0";
...
forcetheorem "}undo" "undo , (?v := ?x) , (command : [[((~ (state : ?1) = [error]) & ((address : ?2) = address : ?v) | error = (rexp : ?x) @ state : ?1) || ((rexp : ?x) @ state : ?1) , (state : ?1) @ address : ?2]]) , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , NOT1 , OR , REFLEX , FNDIST , NONTRIV , AND , TYPES , command , state , rexp , ODDCHOICE , ONEASSIGN , 0";
forcetheorem "MASSIGNTYPE" "MASSIGNTYPE , (?a =:: ?s) , (command : (lexp : ?a) =:: rexp_state : ?s) , EQBOOL , FNDIST , MASSIGNDEF , TYPES , command , rexp , rexp_state , state , 0";
forcetheorem "ONE_ASSIGN" "ONE_ASSIGN , (?v =: ?x) , ([(address : ?1) = address : ?v] =:: [rexp : ?x]) , ONE_ASSIGN , 0";
forcetheorem "ONE_ASSIGN_TYPE" "ONE_ASSIGN_TYPE , (?v =: ?x) , (command : (address : ?v) =: rexp : ?x) , EQBOOL , FNDIST , MASSIGNDEF , ONE_ASSIGN , TYPES , command , rexp , rexp_state , state , 0";
...
forcetheorem "state" "state , (state : ?s) , [data : ?s @ address : ?1] , TYPES , state , 0";
forcetheorem "REXP0" "REXP0 , ((rexp : ?x) @ ?s) , (data : ?x @ state : ?s) , TYPES , rexp , 0";
forcetheorem "CRULE3" "CRULE3 , (?p & |- ?q) , (?p & ?q) , AND , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , REFLEX , TYPES , 0";
forcetheorem "ONEASSIGNTYPE" "ONEASSIGNTYPE , (?v := ?x) , (command : (address : ?v) := rexp : ?x) , AND , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , NOT1 , ODDCHOICE , ONEASSIGN , OR , REFLEX , TYPES , command , rexp , state , 0";
...
forcetheorem "}backup" "backup , (loop @ ?test , ?command) , (command : loop @ ?test , ?command) , LOOP , CASEINTRO , EQBOOL , ERRORDATA , FNDIST , TYPES , command , if , state , 0";
...
adddefdep2 "ONE_ASSIGN_TYPE" "state , command , ARROWTYPE , lexp , rexp , rexp_state , MASSIGNDEF , ONE_ASSIGN , 0";
...
adddefdep2 "ONE_ASSIGN_1" "AND , NOT1 , state , rexp , ARROWTYPE , lexp , rexp_state , MASSIGNDEF , ONE_ASSIGN , 0";
adddefdep2 "ONEASSIGN" "AND , NOT1 , state , OR , rexp , ONEASSIGN , 0";
adddefdep2 "ONE_ASSIGN" "state , ARROWTYPE , lexp , rexp , rexp_state , MASSIGNDEF , ONE_ASSIGN , 0";
adddefdep2 "MASSIGN" "AND , NOT1 , state , ARROWTYPE , lexp , rexp , rexp_state , MASSIGNDEF , 0";
adddefdep2 "MASSIGNTYPE" "state , command , ARROWTYPE , lexp , rexp , rexp_state , MASSIGNDEF , 0";
adddefdep2 "REXPSTATEDATA" "state , rexp , rexp_state , 0";
adddefdep2 "MASSIGNDEF" "state , ARROWTYPE , lexp , rexp , rexp_state , MASSIGNDEF , 0";
adddefdep2 "REXP4" "state , rexp , ARRAYSUB , 0";
...
addthmtextdep2 "ONE_ASSIGN_TYPE" "ONE_ASSIGN_TYPE , ONE_ASSIGN , rexp , state , MASSIGNDEF , lexp , ARROWTYPE , rexp_state , command , 0";
addthmtextdep2 "ONE_ASSIGN" "ONE_ASSIGN , rexp , state , MASSIGNDEF , lexp , ARROWTYPE , rexp_state , 0";
addthmtextdep2 "MASSIGNDEF" "MASSIGNDEF , state , lexp , ARROWTYPE , rexp_state , rexp , 0";
...
addthmtextdep2 "ONE_ASSIGN_1" "ONE_ASSIGN_1 , ONE_ASSIGN , rexp , state , MASSIGNDEF , lexp , ARROWTYPE , rexp_state , NOT1 , AND , 0";
addthmtextdep2 "MASSIGN" "MASSIGN , MASSIGNDEF , state , lexp , ARROWTYPE , rexp_state , rexp , NOT1 , AND , 0";
addthmtextdep2 "MASSIGNTYPE" "MASSIGNTYPE , MASSIGNDEF , state , lexp , ARROWTYPE , rexp_state , rexp , command , 0";
addthmtextdep2 "REXPSTATEDATA" "REXPSTATEDATA , rexp_state , rexp , state , 0";
addthmtextdep2 "REXP4" "REXP4 , ARRAYSUB , state , rexp , 0";
