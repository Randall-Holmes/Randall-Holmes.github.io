declareconstant "inverse";
declareconstant "closure";
declareconstant "IMAGE";
declareconstant "FUNCTION";
declareconstant "function";
declareconstant "bijection";
declareconstant "surjection";
declareconstant "Card";
declareconstant "LESSOREQSIZE_AS_SELF";
declareconstant "LESSOREQSIZE_TRANSITIVE";
declareconstant "LESSOREQSIZE";
declareconstant "injection";
...
forcetheorem "LESSOREQSIZE_TRANSITIVE" "LESSOREQSIZE_TRANSITIVE , (((?A <#= ?B) & ?B <#= ?C) -> ?A <#= ?C) , true , AND , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , IF , IN , LESSOREQSIZE , NONTRIV , NOT1 , ODDCHOICE , OR , REFLEX , TYPES , forall , forsome , injection , 0";
forcetheorem "}backup" "backup , (((?A <#= ?B) & ?B <#= ?C) -> ?A <#= ?C) , true , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , NONTRIV , ODDCHOICE , REFLEX , TYPES , IGNOREFIRST , forall , AND , NOT1 , OR , IF , upfun , forsome , injection , LESSOREQSIZE , IN , 0";
forcetheorem "LESSOREQSIZE" "LESSOREQSIZE , (?A <#= ?B) , (forsome @ [injection @ ?A , ?B , ?1]) , LESSOREQSIZE , 0";
forcetheorem "injection" "injection , (injection @ ?A , ?B , ?f) , (forall @ [forall @ [((?1 << ?A) & ?2 << ?A) -> ((?f @ ?1) << ?B) & (?1 = ?2) = (?f @ ?1) = ?f @ ?2]]) , injection , 0";
...
forcetheorem "LESSOREQSIZE_AS_SELF" "LESSOREQSIZE_AS_SELF , (?A <#= ?A) , true , AND , ASSERT , BOOLDEF , CASEINTRO , EQBOOL , EQUATION , FNDIST , IF , IN , LESSOREQSIZE , NONTRIV , NOT1 , ODDCHOICE , OR , REFLEX , TYPES , forall , forsome , injection , 0";
forcetheorem "Card" "Card , (Card @ [?A]) , [(?A <#= ?1) & ?1 <#= ?A] , Card , 0";
forcetheorem "surjection" "surjection , (surjection @ ?A , ?B , ?f) , (forall @ [(?1 << ?B) -> forsome @ [(?2 << ?A) & (?f @ ?2) = ?1]]) , surjection , 0";
forcetheorem "bijection" "bijection , (bijection @ ?A , ?B , ?f) , ((injection @ ?A , ?B , ?f) & surjection @ ?A , ?B , ?f) , bijection , 0";
forcetheorem "FUNCTION" "FUNCTION , ((forall @ [(?F @ ?x , ?1) == ?1 = ?y]) -> ?y = (function @ ?F) @ ?x) , true , FUNCTION , 0";
forcetheorem "IMAGE" "IMAGE , (?f /| ?A) , [forsome @ [(?2 << ?A) & (?f @ ?2) = ?1]] , IMAGE , 0";
forcetheorem "closure" "closure , (closure @ ?A , ?f) , [forall @ [((?2 |= ?f /| ?2) & ?A |= ?2) -> ?1 << ?2]] , closure , 0";
forcetheorem "inverse" "inverse , (inverse @ ?A , ?B , ?f) , (function @ [((P1 @ ?1) << ?A) & ((P2 @ ?1) << ?B) & (?f @ P2 @ ?1) = P1 @ ?1]) , inverse , 0";
adddef "inverse" "inverse";
adddef "closure" "closure";
adddef "IMAGE" "/|";
adddef "bijection" "bijection";
adddef "surjection" "surjection";
adddef "Card" "Card";
adddef "LESSOREQSIZE" "<#=";
adddef "injection" "injection";
...
setprogram "p2" "p2";
setprogram "p1" "p1";
adddefdep2 "inverse" "AND , ASSERT , IN , P1 , P2 , inverse , 0";
adddefdep2 "closure" "forall , NOT1 , AND , OR , IF , ASSERT , IN , Subset , forsome , IMAGE , closure , 0";
adddefdep2 "IMAGE" "NOT1 , forall , forsome , AND , ASSERT , IN , IMAGE , 0";
adddefdep2 "FUNCTION" "NOT1 , AND , OR , IF , forall , IFF , 0";
adddefdep2 "bijection" "AND , forall , NOT1 , OR , IF , ASSERT , IN , injection , forsome , surjection , bijection , 0";
adddefdep2 "surjection" "forall , NOT1 , AND , OR , IF , ASSERT , IN , forsome , surjection , 0";
adddefdep2 "Card" "AND , NOT1 , forall , forsome , OR , IF , ASSERT , IN , injection , LESSOREQSIZE , Card , 0";
adddefdep2 "LESSOREQSIZE_AS_SELF" "NOT1 , forall , forsome , AND , OR , IF , ASSERT , IN , injection , LESSOREQSIZE , 0";
adddefdep2 "LESSOREQSIZE_TRANSITIVE" "NOT1 , AND , OR , IF , forall , forsome , ASSERT , IN , injection , LESSOREQSIZE , 0";
adddefdep2 "LESSOREQSIZE" "NOT1 , forall , forsome , AND , OR , IF , ASSERT , IN , injection , LESSOREQSIZE , 0";
adddefdep2 "injection" "forall , NOT1 , AND , OR , IF , ASSERT , IN , injection , 0";
...
adddefdep2 "TYPES" "0";
addthmtextdep2 "inverse" "inverse , P1 , IN , ASSERT , P2 , AND , 0";
...
addthmtextdep2 "closure" "closure , forall , IMAGE , forsome , NOT1 , IN , ASSERT , AND , Subset , IF , OR , 0";
...
addthmtextdep2 "IMAGE" "IMAGE , forsome , forall , NOT1 , IN , ASSERT , AND , 0";
addthmtextdep2 "forsome" "forsome , forall , NOT1 , 0";
addthmtextdep2 "NOT1" "NOT1 , 0";
addthmtextdep2 "forall" "forall , 0";
addthmtextdep2 "FUNCTION" "FUNCTION , forall , IFF , IF , NOT1 , OR , AND , 0";
addthmtextdep2 "IFF" "IFF , 0";
addthmtextdep2 "bijection" "bijection , injection , forall , IN , ASSERT , AND , IF , NOT1 , OR , surjection , forsome , 0";
addthmtextdep2 "surjection" "surjection , forall , IN , ASSERT , forsome , NOT1 , AND , IF , OR , 0";
addthmtextdep2 "injection" "injection , forall , IN , ASSERT , AND , IF , NOT1 , OR , 0";
addthmtextdep2 "Card" "Card , LESSOREQSIZE , forsome , forall , NOT1 , injection , IN , ASSERT , AND , IF , OR , 0";
addthmtextdep2 "LESSOREQSIZE" "LESSOREQSIZE , forsome , forall , NOT1 , injection , IN , ASSERT , AND , IF , OR , 0";
addthmtextdep2 "LESSOREQSIZE_AS_SELF" "LESSOREQSIZE_AS_SELF , LESSOREQSIZE , forsome , forall , NOT1 , injection , IN , ASSERT , AND , IF , OR , 0";
addthmtextdep2 "LESSOREQSIZE_TRANSITIVE" "LESSOREQSIZE_TRANSITIVE , LESSOREQSIZE , forsome , forall , NOT1 , injection , IN , ASSERT , AND , IF , OR , 0";
