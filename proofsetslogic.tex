...
\date{version of 3/26/2021 with new material on the unsorted presentation of type theory}
...
language (so the full untyped version of the comprehension axiom does not define any sets, at least in types $\tau^n({\bf x})$ that are not defined in the typed language).
