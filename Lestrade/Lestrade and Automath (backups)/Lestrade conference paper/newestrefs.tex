...
\bibitem{debruijna2} de Bruijn A2, discovered Curry-Howard (give a page reference)

\bibitem{autsl}   de Bruijn, B2, single line Automath

\bibitem{autlambda}  de Bruijn on using abstraction and application to handle definitions:  B7 p. 336  Also p. 275 in autsl

\bibitem{lestradesource}  Holmes, Lestrade source on the web page

\bibitem{lestrademanual} Holmes, Lestrade manual on the web page

\bibitem{hott} Holmes, partial development of HOTT typing

\bibitem{fibonacci}  Holmes, programming of the Fibonacci numbers

\bibitem{juttingb5}  Jutting's discussion of AUT-SYNT

\bibitem{juttingd}  Jutting discussion of his implementation.

\bibitem{grundlagen}  Jutting, curated by Wiedijk, the original Automath book

\bibitem{landau}  Landau's book

\bibitem{yellowbook}  Nederpelt, the Automath book

\bibitem{vandaalena3}  van Daalen, description of AUT-68 and AUT-QE
