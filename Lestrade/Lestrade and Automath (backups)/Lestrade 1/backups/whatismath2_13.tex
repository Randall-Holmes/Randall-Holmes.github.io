...
>>    disjev: that (A disjoint B) {move 2}
...
>>    subsetev: that (A1 <<= A) {move 2}



   declare mapev that ((Union F)=A ++ B)& \
      (F   <<= product disjev) & (Ispartition \
      F)
...
>>    w17: obj {move 2}
   ...
   define Imagemap subsetev mapev : Set F \
      [z      => Exists[w17=> (w17 E A1) \
            & w17 E z] \
         ] \
...
>>         {move 2}
   ...
   define line4 subsetev mapev: Fixform(A1 \
      ...
      Separation3 Refleq   Image subsetev \
      mapev)))
...
>>               {move 4}
            ...
            define line9 whyp1 : Iff1 line8 \
               whyp1 , Ui w1 Separation4            Refleq product disjev
...
>>                           {move 8}
                     ...
                     define line13 xev6: \
                        Ds1                     (line11 xev6,Negintro line12)
...
>>                     {move 6}
                  ...
                  define line17 yev5: Conj(Simp1 \
                     ...
                     yev5, Subs1                  Simp2 yev5 linea6 whyp1))
...
>>                        {move 8}
                     ...
                     define line19 case1: \
                        Add1(z1                     E Image subsetev mapev,                     Subs1 Eqsymm case1 line15 yev5)
...
>>                        {move 7}
                     ...
                     define line20 case2: \
                        Add2(z1                     E A1,Subs1 Eqsymm case2                     line18 yev5)
...
>>                     {move 6}
                  ...
                  define line22 yev5: Iff2 \
                     line21                  yev5,Binaryunion A1,Image                  subsetev mapev,z1
