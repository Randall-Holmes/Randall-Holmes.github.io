...
>>    thehyp: that (z1 E Union((subsetev Imagemap
>>      mapev))) {move 2}



   goal that z1 E A1 ++ Image subsetev mapev


>>    Goal: that (z1 E (A1 ++ (subsetev Image
>>      mapev)))

   define line5 thehyp: Iff1 thehyp, Ui z1, \
      Uthm Imagemap subsetev mapev

>>    line5: [(.z1_1:obj),(thehyp_1:that (.z1_1
>>         E Union((subsetev Imagemap mapev))))
>>         => (---:that Exists([(w_5:obj) => (((.z1_1
>>            E w_5) & (w_5 E (subsetev Imagemap
>>            mapev))):prop)]))
>>         ]
>>      {move 1}
...
>>       w1: obj {move 3}
      ...
      declare whyp1 that (z1 E w1) & w1 E \
...
>>         Imagemap mapev))) {move 3}
      ...
      define linea6 whyp1: Mpsubs Simp2 whyp1, \
         Sepsub2 ( Simp1 Simp2 Simp1 Simp2 \
         mapev, Refleq Imagemap subsetev mapev)
...
>>       line6: [(.w1_1:obj),(whyp1_1:that ((z1
>>            E .w1_1) & (.w1_1 E (subsetev Imagemap
>>            mapev)))) => (---:that ((.w1_1 E
>>            F) & Exists([(w17_9:obj) => (((w17_9
>>               E A1) & (w17_9 E .w1_1)):prop)]))
>>            )]
>>         {move 2}
...
>>       line7: [(.w1_1:obj),(whyp1_1:that ((z1
>>            E .w1_1) & (.w1_1 E (subsetev Imagemap
>>            mapev)))) => (---:that (z1 E .w1_1))]
>>         {move 2}



      define line8 whyp1: Mpsubs Simp1 line6 \
         whyp1,Simp1 Simp2 mapev

>>       line8: [(.w1_1:obj),(whyp1_1:that ((z1
>>            E .w1_1) & (.w1_1 E (subsetev Imagemap
>>            mapev)))) => (---:that (.w1_1 E
>>            product(disjev)))]
>>         {move 2}
      ...
      define line9 whyp1 : Iff1 line8 whyp1 \
         , Ui w1 Separation4 Refleq product \
         disjev

>>       line9: [(.w1_1:obj),(whyp1_1:that ((z1
>>            E .w1_1) & (.w1_1 E (subsetev Imagemap
>>            mapev)))) => (---:that ((.w1_1 E
>>            Sc((A ++ B))) & Exists([(x_13:obj)
...
>>          y4: obj {move 4}
         ...
         declare xev5 that (x5 E A) & Exists[y4 \
               => (y4 E B) & w1 = x5;y4] \
...
>>                x6: obj {move 6}
               ...
               declare xev6 that (x6 E A1) \
                  & x6 E w1

>>                xev6: that ((x6 E A1) & (x6
>>                  E w1)) {move 6}



               define line11 xev6: Iff1 Subs1 \
                  Simp2 yev5 Simp2 xev6, Ui \
                  x6, Pair x5 y5
...
>>                     {move 7}
                  ...
                  define line12 silliness: \
                     ...
                     Simp1 xev6 subsetev ,Subs1 \
                     Eqsymm silliness Simp1 \
                     yev5 ), Simp1 disjev

>>                   line12: [(silliness_1:that
>>                        (x6 = y5)) => (---:that
>>                        ??)]
>>                     {move 6}
...
>>             line16: [(y5_1:obj) => (---:that
>>                  ((y5_1 E (B Set [(y_8:obj)
>>                     => (Exists([(x_9:obj) =>
>>                        (((x_9 E A1) & ((x_9
>>                        ; y_8) E F)):prop)])
>>                     :prop)]))
...
>>               {move 4}
            ...
            define line17 yev5: Conj(Simp1 \
               yev5,Ei1 x5, Conj(line15 yev5, \
               Subs1 Simp2 yev5 linea6 whyp1))
...
>>                  6}
               ...
               define line19 case1: Add1(z1 \
                  E Image subsetev mapev,Subs1 \
                  Eqsymm case1 line15 yev5)


>>                line19: [(case1_1:that (z1
>>                     = x5)) => (---:that ((z1
>>                     E A1) V (z1 E (subsetev
>>                     Image mapev))))]
>>                  {move 5}
               ...
               define line20 case2: Add2(z1 \
                  E A1,Subs1 Eqsymm case2 line18 \
                  yev5)

>>                line20: [(case2_1:that (z1
>>                     = y5)) => (---:that ((z1
>>                     E A1) V (z1 E (subsetev
>>                     Image mapev))))]
>>                  {move 5}
            ...
            define line21 yev5: Cases line10 \
               yev5, line19, line20
...
% pause here for further development
