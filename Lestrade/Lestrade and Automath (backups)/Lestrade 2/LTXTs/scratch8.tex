   ...
   >>> open
      ...
      >>> open
         ...
         line2 : [(uinev_1 : that u E x) => 
             ({def} line1 (uinev_1) Mp 
             u Ui Simp1 (subsev2) : that 
             u E z)]
...
begin Lestrade execution
   ...
   >>> open
      ...
      linea2 : [(u_1 : obj) => 
          ({def} Ded ([(uinev_1 : that 
             u_1 E x) => 
             ({def} uinev_1 : that u_1 E x)]) : that 
          (u_1 E x) -> u_1 E x)]
   ...
   Reflsubset : [(.x_1 : obj), (issetx_1 
       ...
       ([(u_1 : obj) => 
          ({def} Ded ([(uinev_2 : that 
             u_1 E .x_1) => 
             ({def} uinev_2 : that u_1 E .x_1)]) : that 
          (u_1 E .x_1) -> u_1 E .x_1)]) Conj 
   ...
   >>> open
      ...
      >>> open
         ...
         line4 : [(Xsetev_1 : that Isset 
             (X)) => 
             ({def} (X <<= X) Fixform line3 
             Conj Xsetev_1 Conj Xsetev_1 : that 
             X <<= X)]
          ...
          ({def} Ded ([(Xsetev_2 : that 
             ...
             Ug ([(u_2 : obj) => 
                ({def} Ded ([(uinxev_3 
                   ...
                   ({def} uinxev_3 : that 
                   u_2 E X_1)]) : that 
                (u_2 E X_1) -> u_2 E X_1)]) Conj 
             Xsetev_2 Conj Xsetev_2 : that 
             X_1 <<= X_1)]) : that Isset 
          (X_1) -> X_1 <<= X_1)]
...
begin Lestrade execution
   ...
   >>> open
      ...
      linec1 : [
          ({def} Counterexample (thirdev 
          Notconj firstev Conj secondev) : that 
          Exists ([(z_2 : obj) => 
             ({def} ~ ((z_2 E x) -> z_2 
             E y) : prop)]))]
...
{move 1}
   ...
   >>> open
      ...
      line1 : [
          ({def} y Ui x Pair x : that (y E x ; x) == 
          (y = x) V y = x)]
      ...
      line2 : [
          ({def} inev Iff1 line1 : that (y = x) V y = x)]
...
{move 1}
   ...
   >>> open
      ...
      line2 : [
          ({def} line1 Iff2 x Ui x Pair x : that 
          x E x ; x)]
...
{move 1}
   ...
   >>> open
      ...
      scratch1 : [
          ({def} x Ui x Pair y : that (x E x ; y) == 
          (x = x) V x = y)]
      ...
      scratch3 : [
          ({def} scratch2 Iff2 scratch1 : that 
          x E x ; y)]
...
{move 1}
   ...
   >>> open
      ...
      scratch1 : [
          ({def} y Ui x Pair y : that (y E x ; y) == 
          (y = x) V y = y)]
...
{move 1}
   ...
   >>> open
      ...
      one2 : [
          ({def} One ([(w_3 : obj) => 
             ({def} w_3 E Usc (x) : prop)]) Fixform 
          Ei (x, [(w_3 : obj) => 
             ({def} Forall ([(y2_4 : obj) => 
                ({def} (y2_4 E Usc (x)) == 
                y2_4 = w_3 : prop)]) : prop)], one1) : that 
          One ([(w_2 : obj) => 
...
{function error}
   ...
   >>> open
      ...
      line9 : [
          ({def} ((it E x ; y) & (it 
          = x) == y = x) Fixform Theax (x Theother2 
          y) : that (it E x ; y) & (it 
          = x) == y = x)]
      ...
      line10 : [
          ({def} Simp1 (line9) Iff1 it 
          Ui x Pair y : that (it = x) V it 
          = y)]
      ...
      >>> open
         ...
         line11 : [(case1_1 : that it = x) => 
             ({def} case1_1 Iff1 Simp2 (line9) : that 
             y = x)]
         ...
         line12 : [(case1_1 : that it = x) => 
             ({def} Eqsymm (line11 (case1_1)) Subs1 
             case1_1 : that it = y)]
      ...
      line14 : [
          ({def} Cases (line10, [(case1_2 
             : that it = x) => 
             ({def} Eqsymm (case1_2 Iff1 
             Simp2 (line9)) Subs1 case1_2 
             : that it = y)], [(case2_2 
             : that it = y) => 
             ({def} case2_2 : that it = y)]) : that 
          it = y)]
   ...
   Theother3 : [(x_1 : obj), (.y_1 : obj), (.z_1 
       ...
       = x_1 ; .y_1), 
       ({let} .it_1 : [
          ({def} x_1 Theother ispairev_1 
          : obj)]), 
       ({let} .line9_1 : [
          ({def} ((.it_1 E x_1 ; .y_1) & (.it_1 
          = x_1) == .y_1 = x_1) Fixform 
          Theax (x_1 Theother2 .y_1) : that 
          (.it_1 E x_1 ; .y_1) & (.it_1 
          = x_1) == .y_1 = x_1)]) => 
       ({def} Cases (Simp1 (.line9_1) Iff1 
       .it_1 Ui x_1 Pair .y_1, [(case1_2 
          : that .it_1 = x_1) => 
          ({def} Eqsymm (case1_2 Iff1 Simp2 
          (.line9_1)) Subs1 case1_2 : that 
          .it_1 = .y_1)], [(case2_2 : that 
          .it_1 = .y_1) => 
          ({def} case2_2 : that .it_1 = .y_1)]) : that 
       .it_1 = .y_1)]
...
{move 1}
   ...
   >>> open
      ...
      line10 : [
          ({def} One ([(q_3 : obj) => 
             ({def} (q_3 E x $ y) & y E q_3 
             : prop)]) Fixform (x ; y) Ei1 
          line9 : that One ([(q_2 : obj) => 
             ({def} (q_2 E x $ y) & y E q_2 
             : prop)]))]
   ...
   Secondprojthm1 : [(x_1 : obj), (y_1 
       ...
       ; y_1) Ei1 Ug ([(w_1 : obj) => 
          ({def} Dediff ([(yinitinpairev_2 
             : that (w_1 E x_1 $ y_1) & y_1 
             E w_1) => 
             ({def} Cases (Simp1 (yinitinpairev_2) Iff1 
             w_1 Ui (x_1 ; x_1) Pair x_1 
             ; y_1, [(casehyp1_3 : that 
                w_1 = x_1 ; x_1) => 
                ({def} Subs (Eqsymm (Inusc1 
                (casehyp1_3 Subs1 Simp2 (yinitinpairev_2))), [(q_4 
                   : obj) => 
                   ({def} w_1 = x_1 ; q_4 
                   : prop)], casehyp1_3) : that 
                w_1 = x_1 ; y_1)], [(casehyp2_3 
                : that w_1 = x_1 ; y_1) => 
                ({def} casehyp2_3 : that 
                w_1 = x_1 ; y_1)]) : that 
             w_1 = x_1 ; y_1)], [(isunorderedxy_2 
             : that w_1 = x_1 ; y_1) => 
             ({def} Subs (Eqsymm (isunorderedxy_2), [(q_3 
                : obj) => 
                ({def} (q_3 E x_1 $ y_1) & y_1 
             ...
             x_1 Inpair2 y_1) : that (w_1 
             E x_1 $ y_1) & y_1 E w_1)]) : that 
          ((w_1 E x_1 $ y_1) & y_1 E w_1) == 
          w_1 = x_1 ; y_1)]) : that One 
       ([(q_2 : obj) => 
...
{move 1}
   ...
   >>> open
      ...
      >>> open
         ...
         fact1 : [
             ({def} u Ui wev : that ((u E x $ y) & w E u) == 
             u = u)]
      ...
      >>> open
         ...
         >>> open
            ...
            linea5 : [(xev1_1 : that x1 
                E s ; t) => 
                ({def} Cases (linebb2 (xev1_1), [(case1_1 
                   : that x1 = s) => 
                   ({def} Eqsymm (case1_1) Subs1 
                   Simp1 (dir2) : that x1 
                   E u)], [(case2_2 : that 
         ...
         linea6 : [(x1_1 : obj) => 
             ({def} Ded ([(xev1_2 : that 
                x1_1 E s ; t) => 
                ({def} Cases (xev1_2 Iff1 
                x1_1 Ui s Pair t, [(case1_3 
                   : that x1_1 = s) => 
                   ({def} Eqsymm (case1_3) Subs1 
                   Simp1 (dir2) : that x1_1 
                   E u)], [(case2_3 : that 
                   x1_1 = t) => 
                   ({def} Eqsymm (case2_3) Subs1 
                   Simp2 (dir2) : that x1_1 
                   E u)]) : that x1_1 E u)]) : that 
             (x1_1 E s ; t) -> x1_1 E u)]
          ...
          Ug ([(x1_1 : obj) => 
             ({def} Ded ([(xev1_2 : that 
                ...
                x1_1 Ui s Pair t, [(case1_3 
                   ...
                   x1_1 E u)]) : that x1_1 
                E u)]) : that (x1_1 E s ; t) -> 
             x1_1 E u)]) Conj Inhabited 
          (s Inpair1 t) Conj Inhabited (Simp1 
          (dir2_1)) : that (s ; t) <<= 
          u)]
...
{move 1}
   ...
   >>> open
      ...
      lineb2 : [(W_1 : obj) => 
          ({def} Ded ([(absurdhyp_1 : that 
             W_1 E 0) => 
             ({def} (W_1 E x) Giveup absurdhyp_1 
             Mp Empty (W_1) : that W_1 E x)]) : that 
          (W_1 E 0) -> W_1 E x)]
   ...
   >>> open
      ...
      >>> open
         ...
         line1 : [(Xinev_1 : that X E A Set 
             pred) => 
             ({def} Simp1 (Xinev_1 Iff1 
             X Ui A Separation pred) : that 
             X E A)]
      ...
      line2 : [(X_1 : obj) => 
          ({def} Ded ([(Xinev_1 : that 
             X_1 E A Set pred) => 
             ({def} Simp1 (Xinev_1 Iff1 
             X_1 Ui A Separation pred) : that 
             X_1 E A)]) : that (X_1 E A Set 
          pred) -> X_1 E A)]
...
begin Lestrade execution
   ...
   >>> open
      ...
      line1 : [(unioninhyp_1 : that z E Union 
          (y)) => 
          ({def} unioninhyp_1 Iff1 z Ui Uthm 
          (y) : that Exists ([(w_2 : obj) => 
      ...
      >>> open
         ...
         line2 : [(.w1_1 : obj), (wev_1 
             : that (z E .w1_1) & .w1_1 
             E y) => 
             ({def} Simp2 (wev_1) Mpsubs 
             unionsubshyp : that .w1_1 E x)]
         ...
         line3 : [(.w1_1 : obj), (wev_1 
             : that (z E .w1_1) & .w1_1 
             E y) => 
             ({def} Simp1 (wev_1) Conj 
             line2 (wev_1) : that (z E .w1_1) & .w1_1 
             E x)]
      ...
      line5 : [(unioninhyp_1 : that z E Union 
          ...
          y <<= x) => 
          ({def} line1 (unioninhyp_1) Eg 
          [(.w1_2 : obj), (wev_2 : that 
             (z E .w1_2) & .w1_2 E y) => 
             ({def} .w1_2 Ei1 Simp1 (wev_2) Conj 
             Simp2 (wev_2) Mpsubs unionsubshyp_1 
             : that Exists ([(x'_3 : obj) => 
                ({def} (z E x'_3) & x'_3 
                E x : prop)]))] : that 
          Exists ([(x'_2 : obj) => 
...
{function error}
   ...
   >>> open
      ...
      linec1 : [(dir1_1 : that z E x ++ 
          y) => 
          ({def} dir1_1 Iff1 z Ui Uthm (x ; y) : that 
          Exists ([(w_2 : obj) => 
      ...
      >>> open
         ...
         linec2 : [(.w83_1 : obj), (wev83_1 
             ...
             E x ; y) => 
             ({def} Simp2 (wev83_1) Iff1 
             .w83_1 Ui x Pair y : that (.w83_1 
             = x) V .w83_1 = y)]
...
begin Lestrade execution
   ...
   >>> open
      ...
      line1 : [
          ({def} infield Mp s Ui Simp2 (ismap) : that 
          One ([(t_2 : obj) => 
             ({def} (t_2 E F) & s E t_2 
             : prop)]))]
      ...
      theimagefact : [
          ({def} ((theimage E F) & s E theimage) Fixform 
          Theax (line1) : that (theimage 
          E F) & s E theimage)]
...
Witnesses
=============
[(.pred_1 : [(x_2 : obj) => (--- : prop)]), (existsev2_1 : that Exists(.pred_1)), (test_1 : obj) => ({def} .pred_1(test_1) : prop)]
=============
witnessev1
=============
witnessev1
...
(paused, type something to continue) >
            ...
            line8 : [(.v1_1 : obj), (witnessev2_1 
                : that line5 (witnessev1) Witnesses 
                .v1_1) => 
                ({def} line7 (witnessev2_1) Subs1 
                Simp2 (theimagefact) Iff1 
                s Ui u1 Pair .v1_1 : that 
                (s = u1) V s = .v1_1)]
