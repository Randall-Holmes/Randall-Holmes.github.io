...
begin Lestrade execution
   ...
   >>> open
      ...
      >>> open
         ...
         line3 : Ug ([(u_1 : obj) => 
             ({def} Ded ([(uinxev_2 : that 
                u_1 E X) => 
                ({def} uinxev_2 : that u_1 
                E X)]) : that (u_1 E X) -> 
             u_1 E X)])
   ...
   Subsetrefl : Ug ([(X_1 : obj) => 
       ({def} Ded ([(Xsetev_2 : that Isset 
          (X_1)) => 
          ({def} (X_1 <<= X_1) Fixform 
          Ug ([(u_5 : obj) => 
             ({def} Ded ([(uinxev_6 : that 
                u_5 E X_1) => 
                ({def} uinxev_6 : that u_5 
                E X_1)]) : that (u_5 E X_1) -> 
             u_5 E X_1)]) Conj Xsetev_2 
          Conj Xsetev_2 : that X_1 <<= X_1)]) : that 
       Isset (X_1) -> X_1 <<= X_1)])
...
{move 1}
   ...
   >>> open
      ...
      line14 : Cases (line10, [(case1_2 
          : that it = x) => 
          ({def} Eqsymm (case1_2 Iff1 Simp2 
          (line9)) Subs1 case1_2 : that 
          it = y)], [(case2_2 : that 
          it = y) => 
   ...
   Theother3 : [(x_1 : obj), (.y_1 : obj), (.z_1 
       ...
       ({let} .it_1 : [
          ...
          : obj)]) => 
       ({def} Cases (Simp1 (((.it_1 E x_1 
       ; .y_1) & (.it_1 = x_1) == .y_1 
       = x_1) Fixform Theax (x_1 Theother2 
       .y_1)) Iff1 .it_1 Ui x_1 Pair .y_1, [(case1_2 
          : that .it_1 = x_1) => 
          ({def} Eqsymm (case1_2 Iff1 Simp2 
          (((.it_1 E x_1 ; .y_1) & (.it_1 
          = x_1) == .y_1 = x_1) Fixform 
          Theax (x_1 Theother2 .y_1))) Subs1 
          case1_2 : that .it_1 = .y_1)], [(case2_2 
          : that .it_1 = .y_1) => 
...
{move 1}
   ...
   >>> open
      ...
      line8 : [
          ({def} Secondprojthm2 (z, w, y, line7) : that 
          y = w)]
...
begin Lestrade execution
   ...
   >>> open
      ...
      line1 : infield Mp s Ui Simp2 (ismap)
