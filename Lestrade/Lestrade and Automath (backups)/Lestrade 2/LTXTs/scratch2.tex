...
begin Lestrade execution
   ...
   >>> open
      ...
      >>> open
         ...
         >>> comment define commzero2 indhyp \
             : Substitution indhyp, commzero1
         ...
         >>> define commzero2 indhyp : Substitution0 \
             ([zzz => (0 + Succ M3) = (Succ \
                zzz)], indhyp, commzero1)
...
>>>declare zzz in Nat
            ...
            >>> define commindlemma4 commindlemmaindhyp \
                : Substitution0 ([zzz=>(Succ M3 + Succ N3) = Succ zzz], commindlemmaindhyp, \
                commindlemma3)

 Inspector Lestrade says:  objectof a non object line 2749: {function error}

(paused, type something to continue) >
 Inspector Lestrade says:  matchsubsfunction failure line 3582
...
(paused, type something to continue) >
 Inspector Lestrade says:  General failure of betared line 3350
...
(paused, type something to continue) >
 Inspector Lestrade says:  Comparison failed of type and {function error}

(paused, type something to continue) >
 Inspector Lestrade says:  5317:  Object type error in commindlemmaindhyp Substitution commindlemma3
...
(paused, type something to continue) >
 Inspector Lestrade says:  Parse or typefix error in[(commindlemmaindhyp : that (Succ(M3) + N3) = Succ(M3 + N3)) => Substitution()]

(paused, type something to continue) >
>>>declare zzzz in Nat
            >>> define commindlemma5 commindlemmaindhyp \
                : Substitution0 ([zzzz=>(Succ M3 + Succ N3) = Succ zzzz],Eqsymm (Additer \
                M3 N3), commindlemma4 commindlemmaindhyp)

 Inspector Lestrade says:  [commindlemmaindhyp => Substitution (Eqsymm (Additer M3 N3), commindlemma4 commindlemmaindhyp)] is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  [N3 => Deduction (commindlemma5)] is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  Ugen commindlemma6 is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  Induction commindlemma7, commindlemma2 is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  [N3 => Substitution0 ([M4 => (Succ M3 + N3) = M4], Uinst commindlemma N3, commind1 N3)] is not well-formed
...
>>>declare www in Nat
         ...
         >>> define commind3 N3 : Substitution0 \
             ([www => (Succ M3 + N3) = Succ www], Uinst commindhyp N3, commind2 \
             N3)

 Inspector Lestrade says:  [N3 => Substitution (Uinst commindhyp N3, commind2 N3)] is not well-formed

(paused, type something to continue) >

         >>> define commind4 N3 : Substitution0 \
             ( [www => (Succ M3 + N3) = www],Eqsymm (Additer N3 M3), commind3 \
             N3)

 Inspector Lestrade says:  [N3 => Substitution (Eqsymm (Additer N3 M3), commind3 N3)] is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  [commindhyp => propfixform (commuteswithall (Succ M3), Ugen commind4)] is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  [M3 => Deduction commind5] is not well-formed

(paused, type something to continue) >

   >>> define commind7 : Ugen commind6

 Inspector Lestrade says:  Ugen commind6 is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  Induction commind7 commzerobasis is not well-formed
...
(paused, type something to continue) >
 ...
 Inspector Lestrade says:  [term1 term2 => Uinst (Uinst Addcomm term1, term2)] is not well-formed
...
>>>declare qqq in Nat
      ...
      >>> define Polycomptest3 : Substitution0 \
          ([qqq =>( (Polyfuntest Polyapp Nat) Arrowapp 0) = qqq],Arrowcomp (natid, 0), Polycomptest2)
...
(paused, type something to continue) >
 Inspector Lestrade says:  5317:  Object type error in Arrowcomp(natid, 0) Substitution Polycomptest2
...
(paused, type something to continue) >
 Inspector Lestrade says:  Parse or typefix error inSubstitution()
