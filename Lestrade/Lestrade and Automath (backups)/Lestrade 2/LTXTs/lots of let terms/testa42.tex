...
begin Lestrade execution
      ...
      cutsd2 : [
          ({let} .cutsc2_1 : [(B_2 : obj), (Y11_2 
             : obj) => 
             ({def} (Y11_2 <<= prime (B_2)) V B_2 
             <<= Y11_2 : prop)]), (Ba1_1 
          : obj), (Y12_1 : obj) => (--- 
          : prop)]
...
begin Lestrade execution
      ...
      lined78 : [
          ({let} .cutsg2_1 : [(B_2 : obj), (Y11_2 
             : obj) => 
             ({def} B_2 cutsf2 Y11_2 : prop)]), (.B111_1 
          : obj), (bhypa2_1 : that .B111_1 
          E Cuts) => (--- : that Forall 
          ([(x'_2 : obj) => 
             ({def} (x'_2 E Mbold Set [(Y_5 
                : obj) => 
                ({def} .B111_1 cutsg2 Y_5 
                : prop)]) -> prime (x'_2) E Mbold 
             Set [(Y_5 : obj) => 
                ({def} .B111_1 cutsg2 Y_5 
                : prop)] : prop)]))]
