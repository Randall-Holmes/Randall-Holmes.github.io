         ...
         line13 : [
             ({let} .line12_1 : [(u_2 : obj) => 
                ({def} Ded ([(usinev_3 
                   ...
                   (u_2)))) Conj Misset) Iff2 
                   prime (u_2) Ui Scthm 
                   (M) : that prime (u_2) E Sc 
                   (M))]) : that (u_2 
                E Sc (M)) -> prime (u_2) E Sc 
                (M))]) => (--- : that 
             Forall ([(x'_2 : obj) => 
                ({def} (x'_2 E Sc (M)) -> 
...
begin Lestrade execution
         ...
         line26 : [
             ({let} .line25_1 : [(u_2 : obj) => 
                ({def} Ug ([(v_3 : obj) => 
                   ({def} Ded ([(hyp_4 
                      : that (u_2 <<= Sc 
                      (M)) & v_3 E u_2) => 
                      ({def} (((u_2 Intersection 
                      v_3) <<= M) Fixform 
                      Ug ([(w_8 : obj), 
                         ({let} .line16_8 
                         : [
                         ...
                         ({def} Ded ([(hyp2_9 
                            ...
                            v_3 Ui Scthm (M)) : that 
                            w_8 E M)]) : that 
                         (w_8 E u_2 Intersection 
                         v_3) -> w_8 E M)]) Conj 
                      (Isset (u_2 Intersection 
                      v_3) Fixform Separation3 
                      (Refleq (u_2 Intersection 
                      v_3))) Conj Misset) Iff2 
                      (u_2 Intersection v_3) Ui 
                      Scthm (M) : that (u_2 
                      Intersection v_3) E Sc 
                      (M))]) : that ((u_2 
                   <<= Sc (M)) & v_3 E u_2) -> 
                   (u_2 Intersection v_3) E Sc 
                   (M))]) : that Forall 
                ([(x'_3 : obj) => 
                   ({def} ((u_2 <<= Sc 
                   (M)) & x'_3 E u_2) -> 
                   (u_2 Intersection x'_3) E Sc 
                   (M) : prop)]))]) => 
             (--- : that Forall ([(x'_2 
                : obj) => 
                ({def} Forall ([(x'_3 
...
begin Lestrade execution
      ...
      thetascm1 : [
          ({let} .line1_1 : [
             ({def} Misset Mp M Ui Inownpowerset 
             : that M E Sc (M))]), 
          ({let} .line2_1 : [
             ({def} Misset Mp M Ui Scofsetisset 
             Mp Sc (M) Ui Subsetrefl : that 
             Sc (M) <<= Sc (M))]), 
          ({let} .line13_1 : [
             ({let} .line12_2 : [(u_3 : obj) => 
                ({def} Ded ([(usinev_4 
                   : that u_3 E Sc (M)) => 
                   ({def} ((prime (u_3) <<= 
                   M) Fixform Ug ([(v_8 
                   ...
                   prime (u_3) Ui Scthm 
                   (M) : that prime (u_3) E Sc 
                   (M))]) : that (u_3 
                E Sc (M)) -> prime (u_3) E Sc 
                (M))]) => 
             ({def} Ug (.line12_2) : that 
             Forall ([(x'_3 : obj) => 
                ({def} (x'_3 E Sc (M)) -> 
                prime (x'_3) E Sc (M) : prop)]))]), 
          ({let} .line26_1 : [
             ({let} .line25_2 : [(u_3 : obj) => 
                ({def} Ug ([(v_4 : obj) => 
                   ({def} Ded ([(hyp_5 
                      : that (u_3 <<= Sc 
                      (M)) & v_4 E u_3) => 
                ...
                ([(x'_4 : obj) => 
                   ({def} ((u_3 <<= Sc 
                   (M)) & x'_4 E u_3) -> 
                   (u_3 Intersection x'_4) E Sc 
                   (M) : prop)]))]) => 
             ({def} Ug (.line25_2) : that 
             Forall ([(x'_3 : obj) => 
                ({def} Forall ([(x'_4 
                   : obj) => 
                   ({def} ((x'_3 <<= Sc 
                   (M)) & x'_4 E x'_3) -> 
                   (x'_3 Intersection x'_4) E Sc 
                   (M) : prop)]) : prop)]))]) => 
...
{move 2}
      ...
      Thetachainax : [
          ({let} .line4_1 : [(C_2 : obj) => 
             ({def} Dediff ([(hyp2_3 : that 
                C_2 E Thetachain) => 
                ({def} Simp2 (hyp2_3 Iff1 
                C_2 Ui Sc (Sc (M)) Separation 
                thetachain) : that thetachain 
                (C_2))], [(hyp1_3 : that 
                thetachain (C_2)) => 
                ({def} (C_2 E Thetachain) Fixform 
                Simp1 (Simp2 (hyp1_3)) Iff2 
                C_2 Ui Scthm (Sc (M)) Conj 
                hyp1_3 Iff2 C_2 Ui Sc (Sc 
                (M)) Separation thetachain 
                : that C_2 E Thetachain)]) : that 
             (C_2 E Thetachain) == thetachain 
             (C_2))]) => (--- : that 
          Forall ([(x'_2 : obj) => 
...
{move 2}
      ...
      Mboldax : [
          ({let} .Mboldax1_1 : [
             ...
             (Sc (M) E Thetachain) -> 
             Forall ([(x''_4 : obj) => 
                ({def} (x''_4 E Thetachain 
                Intersection Sc (M)) == 
                Forall ([(B1_6 : obj) => 
                   ({def} (B1_6 E Thetachain) -> 
                   x''_4 E B1_6 : prop)]) : prop)]))]), 
          ({let} .line1_1 : [
             ({def} Sc (M) Ui Thetachainax 
             : that (Sc (M) E Thetachain) == 
             thetachain (Sc (M)))]) => 
          (--- : that Forall ([(C_2 : obj) => 
...
{move 2}
      ...
      Lineb1 : [
          ({let} .Linea1_1 : [(F_2 : obj) => 
             ({def} Ded ([(ftheta_3 : that 
                F_2 E Thetachain) => 
                ({def} Simp1 (ftheta_3 Iff1 
                F_2 Ui Thetachainax) : that 
                M E F_2)]) : that (F_2 
             E Thetachain) -> M E F_2)]) => 
          (--- : that Forall ([(x'_2 : obj) => 
             ({def} (x'_2 E Thetachain) -> 
             M E x'_2 : prop)]))]
      ...
      >>> open
         ...
         Line3 : [
             ({let} .line2_1 : [(A_2 : obj) => 
                ({def} Ded ([(ainev_3 
                   : that A_2 E Mbold) => 
                   ({def} thetascm Iff2 Sc 
                   (M) Ui Thetachainax Mp 
                   Sc (M) Ui ainev_3 Iff1 
                   A_2 Ui Mboldax : that A_2 
                   E Sc (M))]) : that 
                (A_2 E Mbold) -> A_2 E Sc 
                (M))]) => (--- : that 
             Forall ([(x'_2 : obj) => 
                ({def} (x'_2 E Mbold) -> 
                x'_2 E Sc (M) : prop)]))]
          ...
          ({let} .Line3_1 : [
             ({let} .line2_2 : [(A_3 : obj) => 
                ({def} Ded ([(ainev_4 
                   ...
                   ({def} thetascm Iff2 Sc 
                   (M) Ui Thetachainax Mp 
                   Sc (M) Ui ainev_4 Iff1 
                   A_3 Ui Mboldax : that A_3 
                   E Sc (M))]) : that 
                (A_3 E Mbold) -> A_3 E Sc 
                (M))]) => 
             ({def} Ug (.line2_2) : that 
             Forall ([(x'_3 : obj) => 
                ({def} (x'_3 E Mbold) -> 
             ...
             ({def} Ded ([(finmbold_3 
                ...
                ({def} Ug ([(G_5 : obj) => 
                   ({def} Ded ([(gtheta_6 
                      ...
                      ({def} gtheta_6 Mp 
                      G_5 Ui finmbold_3 Iff1 
                      F_2 Ui Mboldax Mp F_2 
                      Ui Simp1 (Simp2 (Simp2 
                      (gtheta_6 Iff1 G_5 
                      Ui Thetachainax))) : that 
                      prime2 (thelaw, F_2) E G_5)]) : that 
                   (G_5 E Thetachain) -> 
                   prime2 (thelaw, F_2) E G_5)]) Iff2 
                prime (F_2) Ui Mboldax : that 
                prime (F_2) E Mbold)]) : that 
             (F_2 E Mbold) -> prime (F_2) E Mbold)]) => 
          (--- : that Forall ([(x'_2 : obj) => 
                ...
                ({def} Ded ([(thehyp_4 
                   ...
                   ({def} Ug ([(K_6 : obj) => 
                      ({def} Ded ([(ktheta_7 
                         ...
                         Iff1 K_6 Ui Thetachainax))) : that 
                         (H_2 Intersection 
                         J_3) E K_6)]) : that 
                      (K_6 E Thetachain) -> 
                      (H_2 Intersection J_3) E K_6)]) Iff2 
                   (H_2 Intersection J_3) Ui 
                   Mboldax : that (H_2 Intersection 
                   J_3) E Mbold)]) : that 
                ((H_2 <<= Mbold) & J_3 
