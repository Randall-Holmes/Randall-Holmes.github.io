...
% we are at the end of paragraph 16 on p. 203

\begin{verbatim}

begin Lestrade execution

   >>> comment paragraph 17 page 23
...
{move 1}
   ...
   >>> declare equivev that Mapping disjev \
       Phi


   equivev : that disjev Mapping Phi
   ...
   >>> open
      ...
      >>> define N1 : Set (B, [y1 => Exists \
             [z1 => (z1 E Phi1) & y1 E z1]])
      ...
      >>> comment show that M and N1 are \
          disjoint


      {move 2}

      >>> comment show that nothing is in \
          both M and N1
      ...
      >>> open
         ...
         >>> declare sillyhyp that Exists \
             [z2 => (z2 E M) & z2 E N1]


         sillyhyp : that Exists ([(z2_2 
             : obj) => 
             ({def} (z2_2 E M) & z2_2 E N1 
             : prop)])


         {move 3}

         >>> comment goal is now a contradiction
         ...
         >>> declare localev that (z3 E M) & z3 \
             E N1


         localev : that (z3 E M) & z3 E N1


         {move 3}

         >>> define line171 localev : Simp1 \
             localev


         line171 : [(.z3_1 : obj), (localev_1 
             : that (.z3_1 E M) & .z3_1 
             E N1) => (--- : that .z3_1 
             E M)]
         ...
         >>> define line172 localev : Mpsubs \
             (line171 localev, subsetev)


         line172 : [(.z3_1 : obj), (localev_1 
             : that (.z3_1 E M) & .z3_1 
             E N1) => (--- : that .z3_1 
             E A)]
      ...
      >>> comment show that M is a set


      {move 2}

      >>> comment show that N1 is a set
   ...
   >>> comment show that Phi is a mapping \
       from M to N1
