...
\verbatiminput{docslogs/eqtransitivelogfile.py}
...
This is legacy pasted from a Python window:  a new log file is needed.
...
\verbatiminput{docslogs/pairs2logfile.py}
