...
This version of Marcel frankly has NF as its logic.  This could be changed straightforwardly.
...
Here is a proof that inclusion is transitive.  The text was generated by the new scripting features of the system.
...
The formatting of the automatic output from the scripting function is better in this one.   I did not include
the full proof display at the end as I did in the previous one.
...
This is still old style, pasted from interaction with Python rather than generated by the new script facility.
