...
I have also added reflexivity of equality as an axiom, and the {\em done()} command handles this.  This may have dynamic effects
...
\verbatiminput{coextensionalitylogfile.py}
...
\verbatiminput{atomicinclusionlogfile.py}
