...
\verbatiminput{inclusionistransitivelogfile.py}
\subsection{Equality is transitive}

Here is a proof that equality is transitive.

\verbatiminput{eqtransitivelogfile.py}
...
and the first projection operator on ordered pairs, and the proof that the first projection operator works.

\verbatiminput{pairs2logfile.py}
