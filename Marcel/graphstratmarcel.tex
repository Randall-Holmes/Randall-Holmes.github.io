...
{\tt `} affixed) or set abstracts (discussed subsequently). The
...
supporting data consisting of the path to the current node, the
...
command can then handle all basic sequent rules.
