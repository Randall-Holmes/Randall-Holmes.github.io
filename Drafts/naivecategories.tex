...
Abstract, we say that an equalizer of $f,g:A \rightarrow B$ is an arrow $i:E \rightarrow A$ with the property that $f \circ i = g\circ i$ and for any $h:C \rightarrow A$ such that $f \circ h = g \circ h$ we find a unique arrow $k:C \rightarrow E$ such that $i \rightarrow k = h$.
