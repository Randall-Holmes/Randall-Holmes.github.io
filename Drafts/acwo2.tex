...
A choice set from the well-ordered partition obtained by dropping empty sets from the range of this sequence readily gives us a well-orderable set which meets each nonempty set in the original sequence in a single element (which we briefly call a choice set from the nonempty sets of the original sequence).
