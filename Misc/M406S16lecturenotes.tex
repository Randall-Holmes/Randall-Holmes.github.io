...
\date{4/18/2018:  the equivalence of the two definitions of Carmichael number is proved, in the section on effectiveness of Rabin-Miller, AT LAST!  4/5/2018:  tidying up notes on which integers are sums of two squares.  3/28/18:  exercises added (section 23).  3/21/2018:  clarifications of proof of third part of QR theorem.  3/15/2018:  El Gamal section added; corrections to QR notes.  3/8/2018:  error in discussion of final digits of perfect numbers corrected.  3/9/18:  new homework, corrected factorization error in the Primitive Root Theorem section.  I owe you a subsection on the ElGamal system.}
...
\item[cancellation:]  For any natural numbers $a,b$, $a+1=b+1$ implies $a=b$.
...
\subsection{Exercises (assigned 1/12/2018):}  

These exercises were assigned on F 1/12/2018 and are due F 1/19/2018.

\begin{enumerate}

\item Using just the official axioms above, prove that if $a,b,c$ are natural numbers and if
$a<b$ and $b<c$, then $a<c$.  This is not an induction proof!
...
\item (peeking ahead at the next section, since we got farther than the 2016 lot before this assignment)  The Division Algorithm theorem tells us that for each integer $a$ and positive integer $b$ there is a unique pair of integers $q,r$ such that
...
NOTE:  previous paragraph is corrected due to an observant student.  I originally wrote  $a-(-a)b = (-a)(b-1) \geq 0$ which is simply wrong.

%editing point to Elbakri for noticing error in previous paragraph
...
\subsection{An Absence of Exercises}

I'll give a new set of problems after the next lecture.
