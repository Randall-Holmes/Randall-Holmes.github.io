...
if we factor a perfect cube into two coprime factors, they must also be perfect cubes, so we may set $r^3=2u$, $s^3=u^2+3v^2$.
...
By the Key Lemma we have  $s=e^2+3f^2$ where $e,f$ are coprime, $$v=e(e^2-9f^2); w=3f(e^2-f^2).$$
