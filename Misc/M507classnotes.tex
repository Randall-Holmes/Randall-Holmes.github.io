...
Now the punchline is...look at the definition.  $F(t) = F([t])$, because $F(t) = \Sigma_{n\leq t} f(n) = \Sigma_{n \leq [t]} f(n)$.  I would {\bf never} have written the proof the way he does without a clarifying remark about that step!

The definition of Euler's constant $\gamma$ in the proof of theorem 6.9 is definitely wrong.  He has $\gamma = \int_1\,\frac{\{t\}}{t^2}\,dt$, and it definitely isn't.  I know what Euler's constant is pictorially (look at 

\verb https://en.wikipedia.org/wiki/Euler%E2%80%93Mascheroni_constant ) 

and it is definitely $\gamma = \int_1\,\frac{\{t\}}{t[t]}\,dt$.
