...
We argue that for every $a,b$ there is an $n$ such that $D_{n+1}=0$ and $D_n = {\tt gcd}(a,b)$.
...
The sequence which starts $D_0=a, D_1 = k+1, D_2 = a \,{\tt mod} \, (k+1)\ldots$ can then be seen to terminate because the sequence beginning $D_1 = k+1, D_2 = a \,{\tt mod} \, (k+1)\ldots$ must terminate by ind hyp, because
$a \,{\tt mod} \, (k+1) \leq k$ (if $a \,{\tt mod} \, (k+1)$ is zero, the original sequence terminates and the tail sequence isn't even a $D$ sequence).
...
If you don't, still fear not.  The first thing I'm doing on Friday is re-lecturing the statement of the Euclidean algorithm
in this format.
