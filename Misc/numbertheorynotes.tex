...
$D_{k+1} = D_k - (D_k {\tt div}D_{k-1})D_{k-1}$ which by ind hyp

$= (aX_k + bY_k) - (D_k {\tt div}D_{k-1})(aX_{k-1}+bY_{k-1})$ which by algebra

$= a(X_k - (D_k {\tt div}D_{k-1})X_{k-1}) + b(Y_k - (D_k {\tt div}D_{k-1})Y_{k-1})$ which by the recurrence relation for $X$ and $Y$
